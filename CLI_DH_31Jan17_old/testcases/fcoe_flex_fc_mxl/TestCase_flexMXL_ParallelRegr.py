...
'''
    script for parallel execution of Flex_MXL cases
'''
...
class Testcase_parallel(TemplateTestBase,DiscoverResourceTestBase):
    ...
    def run_Thread_1(self):
        ...
        test1 = TestCase_104080.Testcase()
        test1.test_createTemplate()
        test2 = TestCase_104081.Testcase()
        test2.test_createTemplate()
        test3 = TestCase_104083.Testcase()
        test3.test_createTemplate()
        test4 = TestCase_104087.Testcase()
        test4.test_createTemplate()
        
    def run_Thread_2(self):
        print threading.currentThread().getName(), 'Starting.......'
        test6 = TestCase_104088.Testcase()
        test6.test_createTemplate()
        test7 = TestCase_104089.Testcase()
        test7.test_createTemplate()
        test8 = TestCase_104092.Testcase()
...
if __name__ == "__main__":
    try:
        ...
        threading.local()
        t1 = threading.Thread(name='FLEX_MXL_Thread_1',target=test.run_Thread_1)
        t2 = threading.Thread(name='FLEX_MXL_Thread_2',target=test.run_Thread_2)
        t1.start()
        t2.start()
