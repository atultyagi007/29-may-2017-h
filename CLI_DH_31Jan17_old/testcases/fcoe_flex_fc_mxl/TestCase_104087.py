...
class Testcase(TemplateTestBase,DiscoverResourceTestBase):
    ...
    def test_createTemplate(self):
        ...
        payload = self.readFile(globalVars.filename_TestCase_before_104087_scaleup_bladeserver)
        self.getResources()
        
        networkTypeServer1=inputForNetworkType.TestCase_104087_networkType_server1
        networkTypeServer2=inputForNetworkType.TestCase_104087_networkType_server2
        ...
        if templateResponse.status_code in (200, 201, 202, 203, 204):
            ...
            self.log_TestData(["", "", "", str(testCaseID), testCaseDescriptionMapping.TestCase_104087, 'Success','Template created  and published Successfully','Server : Blade Server'])
            self.test_publishTemplate()
            
        else:
            self.log_TestData(["", "", "", str(testCaseID),testCaseDescriptionMapping.TestCase_104087, 'Failed','Failed to create/published template'])
    ...
    def test_publishTemplate(self):
        ...
        DeplName='TestCase_104087'
        deplyDesc=testCaseDescriptionMapping.TestCase_104087
    ...
    def test_scaleUpTemplate(self, templateID, deploymentRefId, DeplName, deplyDesc):
        ...
        payload = self.readFile(globalVars.filename_TestCase_104087_afte_scaleup_bladeserver)
        network_Type = inputForNetworkType.TestCase_104087_scaleUp_networkType
        if not network_Type:
