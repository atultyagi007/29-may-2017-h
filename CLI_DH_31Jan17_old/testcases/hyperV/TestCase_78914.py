...
class Testcase(TemplateTestBase,DiscoverResourceTestBase):
    """
    Deploy a HyperV R2 instance on 2 R720s with 2 Compellent storage volumes and a cluster
    """ 
    ...
    def test_createTemplate(self):
        ...
        payload = self.readFile(globalVars.filename_TestCase_78914)
        self.getResources()
        networkTypeServer1=inputForNetworkType.TestCase_78914_networkType_server1
        networkTypeServer2=inputForNetworkType.TestCase_78914_networkType_server1
        ...
        if templateResponse.status_code in (200, 201, 202, 203, 204):
            ...
            self.log_TestData(["", "", "", str(self.tc_Id), testCaseDescriptionMapping.TestCase_78914, 'Success','Template created  and published Successfully','Server:2 R720 Rack Server'])
            self.log_data( 'Successfully created  and published Template ')
            statausCreateTemplae = self.test_publishTemplate()
            
        else:
            self.log_TestData(["", "", "", str(self.tc_Id), testCaseDescriptionMapping.TestCase_78914, 'Failed','Failed to create/published template'])
    ...
    def test_publishTemplate(self):
        ...
        DeplName='TestCase_78914'
        deplyDesc=testCaseDescriptionMapping.TestCase_78914
