...
class Testcase(TemplateTestBase,DiscoverResourceTestBase):
    """
    Deploy a HyperV non-R2 instance on 2 R720s with 2 Compellent storage volumes and a cluster
    """ 
    ...
    def preRunSetup(self):
        ...
        servers = []
        serverType = serverPoolValue.TestCase_78805
    ...
    def test_createTemplate(self):
        ...
        payload = self.readFile(globalVars.filename_TestCase_78913)
        self.getResources()
        networkTypeServer1=inputForNetworkType.TestCase_78913_networkType_server1
        networkTypeServer2=inputForNetworkType.TestCase_78913_networkType_server2
        ...
        for device in compellentList:
            if device['ip']==globalVars.compellent_hyperV_rack:
        ...
        if templateResponse.status_code in (200, 201, 202, 203, 204):
            ...
            self.log_TestData(["", "", "", str(self.tc_Id), testCaseDescriptionMapping.TestCase_78913, 'Success','Template created  and published Successfully','Server:2 R720 Rack Servers'])
            self.log_data( 'Successfully created  and published Template ')
            statausCreateTemplae = self.test_publishTemplate()
            
        else:
            self.log_TestData(["", "", "", str(self.tc_Id), testCaseDescriptionMapping.TestCase_78913, 'Failed','Failed to create/published template'])
    ...
    def test_publishTemplate(self):
        ...
        DeplName='TestCase_78913'
        deplyDesc=testCaseDescriptionMapping.TestCase_78913
