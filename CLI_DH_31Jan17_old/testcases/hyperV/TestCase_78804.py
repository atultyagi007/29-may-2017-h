...
class Testcase(TemplateTestBase,DiscoverResourceTestBase):
    ...
    def preRunSetup(self):
        ...
        print (" test case Id : %s"%str(self.tc_Id))
    ...
    def test_createTemplate(self):
        ...
        self.getResources()
        networkType=inputForNetworkType.TestCase_78804_networkType
        ...
        if templateResponse.status_code in (200, 201, 202, 203, 204):
            ...
            self.log_TestData(["", "", "", str(self.tc_Id), testCaseDescriptionMapping.TestCase_78804, 'Success','Template created  and published Successfully','Server : R720 Rackserver'])
            self.log_data( 'Successfully created  and published Template ')
            statausCreateTemplae = self.test_publishTemplate()
            
        else:
            self.log_TestData(["", "", "", str(self.tc_Id), testCaseDescriptionMapping.TestCase_78804, 'Failed','Failed to create/published template'])
...
#           
        ...
        DeplName='TestCase_78804'
        deplyDesc=testCaseDescriptionMapping.TestCase_78804
