...
class Testcase(TemplateTestBase,DiscoverResourceTestBase):
    """
    Deploy a HyperV non-R2 instance on 2 R620s with 2 Compellent storage volumes and a cluster
    """ 
    ...
    def test_createTemplate(self):
        ...
        payload = self.readFile(globalVars.filename_TestCase_78915)
        self.getResources()
        networkTypeServer1=inputForNetworkType.TestCase_78915_networkType_server1
        networkTypeServer2=inputForNetworkType.TestCase_78915_networkType_server2
        ...
        if templateResponse.status_code in (200, 201, 202, 203, 204):
            ...
            self.log_TestData(["", "", "", str(self.tc_Id), testCaseDescriptionMapping.TestCase_78915, 'Success','Template created  and published Successfully','Server:2 R620 Rack Servers'])
            self.log_data( 'Successfully created  and published Template ')
            statausCreateTemplae = self.test_publishTemplate()
            
        else:
            self.log_TestData(["", "", "", str(self.tc_Id), testCaseDescriptionMapping.TestCase_78915, 'Failed','Failed to create/published template'])
    ...
    def test_publishTemplate(self):
        ...
        DeplName='TestCase_78915'
        deplyDesc=testCaseDescriptionMapping.TestCase_78915
