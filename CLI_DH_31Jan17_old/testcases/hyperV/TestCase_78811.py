...
class Testcase(TemplateTestBase,DiscoverResourceTestBase):
    """
    Deploy a HyperV R2 instance on 2 R620s with 2 storage volumes and a cluster
    """ 
    tc_Id=""
    ...
    def test_createTemplate(self):
        ...
        payload = self.readFile(globalVars.filename_TestCase_78811)
        self.getResources()
        networkTypeServer1=inputForNetworkType.TestCase_78811_networkType_server1
        networkTypeServer2=inputForNetworkType.TestCase_78811_networkType_server2
        ...
        if templateResponse.status_code in (200, 201, 202, 203, 204):
            ...
            self.log_TestData(["", "", "", str(self.tc_Id), testCaseDescriptionMapping.TestCase_78811, 'Success','Template created  and published Successfully','Server:2 R620 Rack Servers'])
            self.log_data( 'Successfully created  and published Template ')
            statausCreateTemplae = self.test_publishTemplate()
            
        else:
            self.log_TestData(["", "", "", str(self.tc_Id), testCaseDescriptionMapping.TestCase_78811, 'Failed','Failed to create/published template'])
    ...
    def test_publishTemplate(self):
        ...
        DeplName='TestCase_78811'
        deplyDesc=testCaseDescriptionMapping.TestCase_78811
