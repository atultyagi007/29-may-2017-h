...
class Testcase(TemplateTestBase,DiscoverResourceTestBase):
    """
    Deploy 2 rack servers with HyperV on Windows 2012 R2 with 2 storage volumes and a cluster
    """ 
    ...
    def preRunSetup(self):
        ...
        servers = []
        serverType = serverPoolValue.TestCase_78809
    ...
    def test_createTemplate(self):
        ...
        self.setNetworkList()
        payload = self.readFile(globalVars.filename_TestCase_78809)
        self.log_data(" Going to Create Template :: ")
        self.getResources()
        networkTypeServer1=inputForNetworkType.TestCase_78809_networkType_server1
        networkTypeServer2=inputForNetworkType.TestCase_78809_networkType_server2
        ...
        if templateResponse.status_code in (200, 201, 202, 203, 204):
            ...
            self.log_TestData(["", "", "", str(self.tc_Id),testCaseDescriptionMapping.TestCase_78809, 'Success','Template created  and published Successfully','Server:2 R720 Rack Servers'])
            self.log_data( 'Successfully created  and published Template ')
            statausCreateTemplae = self.test_publishTemplate()
            
        else:
            self.log_TestData(["", "", "", str(self.tc_Id),testCaseDescriptionMapping.TestCase_78809, 'Failed','Failed to create/published template'])
    ...
    def test_publishTemplate(self):
        ...
        DeplName='TestCase_78809'
        deplyDesc=testCaseDescriptionMapping.TestCase_78809
