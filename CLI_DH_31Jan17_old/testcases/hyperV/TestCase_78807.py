...
class Testcase(TemplateTestBase,DiscoverResourceTestBase):
    """
    Deploy 2 rack servers with HyperV on Windows 2012 non-R2 with 2 storage volumes and a cluster
    """ 
    ...
    def preRunSetup(self):
        ...
        servers = []
        serverType = serverPoolValue.TestCase_78807
    ...
    def test_createTemplate(self):
        ...
        payload = self.readFile(globalVars.filename_TestCase_78807)
        self.log_data(" Going to Create Template :: ")
        self.getResources()
        networkTypeServer1=inputForNetworkType.TestCase_78807_networkType_server1
        networkTypeServer2=inputForNetworkType.TestCase_78807_networkType_server2
        ...
        if templateResponse.status_code in (200, 201, 202, 203, 204):
            ...
            self.log_TestData(["", "", "", str(self.tc_Id), testCaseDescriptionMapping.TestCase_78807, 'Success','Template created  and published Successfully','Server:2 R620 Rack Server'])
            self.log_data( 'Successfully created  and published Template ')
            statausCreateTemplae = self.test_publishTemplate()
            
        else:
            self.log_TestData(["", "", "", str(self.tc_Id), testCaseDescriptionMapping.TestCase_78807, 'Failed','Failed to create/published template'])
    ...
    def test_publishTemplate(self):
        ...
        DeplName='TestCase_78807'
        deplyDesc=testCaseDescriptionMapping.TestCase_78807
