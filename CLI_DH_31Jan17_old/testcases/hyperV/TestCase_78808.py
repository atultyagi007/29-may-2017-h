...
class Testcase(TemplateTestBase,DiscoverResourceTestBase):
    """
    Deploy a rack server with HyperV on Windows 2012 R2 with 2 storage volumes and a cluster
    """ 
    ...
    def preRunSetup(self):
        ...
        servers = []
        serverType = serverPoolValue.TestCase_78808
    ...
    def test_createTemplate(self):
        ...
        self.setNetworkList()
        payload = self.readFile(globalVars.filename_TestCase_78808)
        self.log_data(" Going to Create Template :: ")
        self.getResources()
        networkType=inputForNetworkType.TestCase_78808_networkType
        ...
        if templateResponse.status_code in (200, 201, 202, 203, 204):
            ...
            self.log_TestData(["", "", "", str(self.tc_Id),testCaseDescriptionMapping.TestCase_78808, 'Success','Template created  and published Successfully','Server: R720 Rack Server'])
            self.log_data( 'Successfully created  and published Template ')
            statausCreateTemplae = self.test_publishTemplate()
            
        else:
            self.log_TestData(["", "", "", str(self.tc_Id), testCaseDescriptionMapping.TestCase_78808, 'Failed','Failed to create/published template'])
    ...
    def test_publishTemplate(self):
        ...
        DeplName='TestCase_78808'
        deplyDesc=testCaseDescriptionMapping.TestCase_78808
