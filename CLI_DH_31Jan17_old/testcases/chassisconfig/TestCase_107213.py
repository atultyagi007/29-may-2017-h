...
'''
    Test Case Description : Add new CMC user with Admin group
'''
...
class TestCMCUser(TemplateTestBase,DiscoverResourceTestBase,UtilBase):
    ...
    def createCMCUser(self):
        ...
        cmcUser = '''[{"username": "adminuser","password": "admin123","role": "Administrator" ,"confirmpassword": "","lan": "","idracrole": "","serialoverlan": false,"enabled":true}]'''
