...
'''
    Add new CMC user with mismatch password (password and confirm password)
'''
...
class TestCMCUser(TemplateTestBase,DiscoverResourceTestBase,UtilBase):
    ...
    def createCMCUser(self):
        ...
        cmcUser = '''[{"username": "mismatch1","password": "mismatch","role": "" ,"confirmpassword": "matchmiss","lan": "","idracrole": "","serialoverlan": false,"enabled":false}]'''
        ...
        self.log_data(" FINAL PAYLOAD AFTER CHASSIS ")
