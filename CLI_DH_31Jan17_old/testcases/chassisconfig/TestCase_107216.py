...
'''
    Test Case Description : Add new CMC user with None group
'''
...
class TestCMCUser(TemplateTestBase,DiscoverResourceTestBase,UtilBase):
    ...
    def createCMCUser(self):
        ...
        cmcUser = '''[{"username": "Noneuser1","password": "none123","role": "" ,"confirmpassword": "","lan": "","idracrole": "","serialoverlan": false,"enabled":true}]'''
