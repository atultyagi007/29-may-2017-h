...
'''    
    Discover a chassis and configure the chassis to use static IP for servers with existing credentials
...
class Testcase(DiscoverResourceTestBase):
    ...
    def postConfigureProcess(self,refId):
        ...
        payload = self.readFile(globalVars.filename_TestCase_104147)
    ...
    def postConfigureDiscover(self,refId):
        ...
        #print " Response and status from configure/discover : "
        #print response.text
        return response,status  
