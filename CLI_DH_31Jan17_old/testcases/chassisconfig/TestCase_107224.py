...
'''
    ...
    Test Case 107224 : Add new iDrac user with No Access role
    Test Case 107228 : Add new iDrac user with None LAN role
'''
...
class TestiDRACUser(TemplateTestBase,DiscoverResourceTestBase,UtilBase):
    ...
    def createiDRACUser(self):
        ...
        iDRACUser = '''[{"username": "iDRACNOAccess","password": "9876543","role": "" ,"confirmpassword": "","lan": "No Access","idracrole": "None","serialoverlan": false,"enabled":true}]'''
