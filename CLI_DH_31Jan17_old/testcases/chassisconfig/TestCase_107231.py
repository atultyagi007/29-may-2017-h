...
'''
    Add new iDrac user with disabled mode
...
class TestiDRACUser(TemplateTestBase,DiscoverResourceTestBase,UtilBase):
    ...
    def createiDRACUser(self):
        ...
        iDRACUser = '''[{"username": "disabledUser","password": "userdisabled","role": "" ,"confirmpassword": "","lan": "Administrator","idracrole": "Operator","serialoverlan": false,"enabled":false}]'''
