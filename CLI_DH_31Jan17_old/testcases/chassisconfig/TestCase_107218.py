...
'''
    ...
    Test Case 107218 : Add new CMC user with disabled mode
    Test Case 107219 : Add new CMC user with max characters name
'''
...
class TestCMCUser(TemplateTestBase,DiscoverResourceTestBase,UtilBase):
    ...
    def createCMCUser(self):
        ...
        cmcUser = '''[{"username": "Userwithmaxchars","password": "maxchar","role": "" ,"confirmpassword": "","lan": "","idracrole": "","serialoverlan": false,"enabled":false}]'''
