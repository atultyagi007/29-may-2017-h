...
'''
    Test Case Description : Add new CMC user with Guest user group
'''
...
class TestCMCUser(TemplateTestBase,DiscoverResourceTestBase,UtilBase):
    ...
    def createCMCUser(self):
        ...
        cmcUser = '''[{"username": "Guestuser1","password": "guest123","role": "GuestUser" ,"confirmpassword": "","lan": "","idracrole": "","serialoverlan": false,"enabled":true}]'''
