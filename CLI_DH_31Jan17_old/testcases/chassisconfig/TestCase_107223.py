...
'''
    ...
    Test Case 107223 : Add new iDrac user with User role
    Test Case 107227 : Add new iDrac user with Read-Only LAN role
'''
...
class TestiDRACUser(TemplateTestBase,DiscoverResourceTestBase,UtilBase):
    ...
    def createiDRACUser(self):
        ...
        iDRACUser = '''[{"username": "iDRACUser4","password": "idr789456","role": "" ,"confirmpassword": "","lan": "User","idracrole": "ReadOnly","serialoverlan": false,"enabled":true}]'''
