...
'''
    This script covers two test casee : 
    Test Case 107221 : Add new iDrac user with Admin role
    Test Case 107225 : Add new iDrac user with Admin LAN role
'''
...
class TestiDRACUser(TemplateTestBase,DiscoverResourceTestBase,UtilBase):
    ...
    def createiDRACUser(self):
        ...
        iDRACUser = '''[{"username": "iDRACUser1","password": "idrac123","role": "" ,"confirmpassword": "","lan": "Administrator","idracrole": "Administrator","serialoverlan": false,"enabled":true}]'''
