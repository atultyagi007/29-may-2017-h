...
'''
    ...
    Test Case 107222 : Add new iDrac user with Operator role
    Test Case 107226 : Add new iDrac user with Operator LAN role
'''
...
class TestiDRACUser(TemplateTestBase,DiscoverResourceTestBase,UtilBase):
    ...
    def createiDRACUser(self):
        ...
        iDRACUser = '''[{"username": "iDRACUser2","password": "idrac123","role": "" ,"confirmpassword": "","lan": "Operator","idracrole": "Operator","serialoverlan": false,"enabled":true}]'''
