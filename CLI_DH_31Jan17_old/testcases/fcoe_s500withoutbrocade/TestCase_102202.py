...
class Testcase(TemplateTestBase,DiscoverResourceTestBase):
    """
    Deploy 2 rack servers using ESX 5.1 with 2 existing compellent volumes to a new cluster
    """ 
...
#             print " No RackServers found of type : '%s'",str(serverType)
    ...
    def test_publishTemplate(self):
        ...
        DeplName='TestCase_102202'
        deplyDesc='Deploy 2 rack servers using ESX 5.1 with 2 existing compellent volumes to a new cluster'
