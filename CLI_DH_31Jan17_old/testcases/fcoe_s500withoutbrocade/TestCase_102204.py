...
class Testcase(TemplateTestBase,DiscoverResourceTestBase):
    """
    Deploy 2 blade servers using ESX 5.1 with 1compellent volume to a Existing cluster
    """ 
...
#             print " No BladeServers found of type : '%s'",str(serverType)
    ...
    def test_createTemplate(self):
        ...
        self.setNetworkList()
        payload = self.readFile(globalVars.filename_TestCase_102204)
        self.getResources()
    ...
    def test_publishTemplate(self):
        ...
        DeplName='TestCase_102204'
        deplyDesc='Deploy 2 blade servers using ESX 5.1 with 1compellent volume to a Existing cluster'
