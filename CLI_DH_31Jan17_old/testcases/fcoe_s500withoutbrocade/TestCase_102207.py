...
#             print " No BladeServers found of type : '%s'",str(serverType)
    ...
    def test_createTemplate(self):
        ...
        self.setNetworkList()
        payload = self.readFile(globalVars.filename_TestCase_102207)
        self.getResources()
    ...
    def test_publishTemplate(self):
        ...
        DeplName='TestCase_102207'
        deplyDesc='Deploy 1 blade servers using ESX 5.1 with 1 compellent volume to a Existing cluster'
