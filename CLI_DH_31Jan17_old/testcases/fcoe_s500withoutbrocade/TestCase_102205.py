...
#             print " No RackServers found of type : '%s'",str(serverType)
    ...
    def test_createTemplate(self):
        ...
        self.setNetworkList()
        payload = self.readFile(globalVars.filename_TestCase_102205)
        self.getResources()
    ...
    def test_publishTemplate(self):
        ...
        DeplName='TestCase_102205'
        deplyDesc='Deploy 1 rack server using ESX 5.1 with 2 compellent volume to a  Existing cluster'
