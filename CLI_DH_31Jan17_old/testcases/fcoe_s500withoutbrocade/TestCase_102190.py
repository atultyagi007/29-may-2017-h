...
class Testcase(TemplateTestBase,DiscoverResourceTestBase):
    """
    Deploy 2 rack servers using ESX 5.5 with 2 compellent volumes to a new cluster
    """ 
    ...
    def test_createTemplate(self):
        ...
        self.setNetworkList()
        payload = self.readFile(globalVars.filename_TestCase_102190)
        self.getResources()
