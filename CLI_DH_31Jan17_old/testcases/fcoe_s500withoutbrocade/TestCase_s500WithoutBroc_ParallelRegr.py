...
'''
    script for parallel execution of S500 without brocade cases
'''
...
import TestCase_102204
import TestCase_102205
import TestCase_102207
...
class Testcase_parallel(TemplateTestBase,DiscoverResourceTestBase):
    ...
    def run_Thread_1(self):
        ...
        test1 = TestCase_102190.Testcase()
        test1.test_createTemplate()
        test2 = TestCase_102192.Testcase()
        test2.test_createTemplate()
        test3 = TestCase_102193.Testcase()
        test3.test_createTemplate()
        
        
    def run_Thread_2(self):
        print threading.currentThread().getName(), 'Starting.......'
        test4 = TestCase_102195.Testcase()
        test4.test_createTemplate()
        test5 = TestCase_102202.Testcase()
        test5.test_createTemplate()
        test6 = TestCase_102204.Testcase()
        test6.test_createTemplate()
                
    def run_Thread_3(self):
        test7 = TestCase_102205.Testcase()
        test7.test_createTemplate()
        test8 = TestCase_102207.Testcase()
...
if __name__ == "__main__":
    try:
        ...
        threading.local()
        t1 = threading.Thread(name='S500WithoutBrocade_Thread_1',target=test.run_Thread_1)
        t2 = threading.Thread(name='S500WithoutBrocade_Thread_2',target=test.run_Thread_2)
        t3 = threading.Thread(name='S500WithoutBrocade_Thread_3',target=test.run_Thread_3)
        t1.start()
        t2.start()
        t3.start()
