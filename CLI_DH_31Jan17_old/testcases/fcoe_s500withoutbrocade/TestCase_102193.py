...
class Testcase(TemplateTestBase,DiscoverResourceTestBase):
    """
    Deploy 1 rack server using ESX 5.5 with 2 compellent volumes to an existing cluster
    """ 
...
#             print " No RackServers found of type : '%s'",str(serverType)
    ...
    def test_createTemplate(self):
        ...
        self.setNetworkList()
        payload = self.readFile(globalVars.filename_TestCase_102193)
        self.getResources()
    ...
    def test_publishTemplate(self):
        ...
        DeplName='TestCase_102193'
        deplyDesc='Deploy 1 rack server using ESX 5.5 with 2 compellent volumes to an existing cluster'
