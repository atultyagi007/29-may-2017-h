...
class Testcase(TemplateTestBase,DiscoverResourceTestBase):
    """
    Deploy 1 blade servers using ESX 5.5 with 1 compellent volume to a new cluster
    """ 
...
#             print " No BladeServers found of type : '%s'",str(serverType)
    ...
    def test_publishTemplate(self):
        ...
        DeplName='TestCase_102195'
        deplyDesc='Deploy 1 blade servers using ESX 5.5 with 1 compellent volume to a new cluster'
