...
class Testcase(TemplateTestBase,DiscoverResourceTestBase):
    """
    Deploy 2 servers with ESXI with 2 storage volumes,Mem Enable and a cluster with DRS Enable
    """ 
    ...
    def preRunSetup(self):
        ...
        if(len(servers) > 0):
            ...
            print " No BldeServers found of type : '%s'",str(serverType)
    ...
    def test_createTemplate(self):
        ...
        self.setNetworkList()
        payload = self.readFile(globalVars.filename_TestCase_81195)
        self.getResources()
        
        
        networkTypeServer1=inputForNetworkType.TestCase_81195_networkType_server1
        networkTypeServer2=inputForNetworkType.TestCase_81195_networkType_server2
        ...
        if templateResponse.status_code in (200, 201, 202, 203, 204):
            ...
            self.log_TestData(["", "", "",str(self.tc_Id), testCaseDescriptionMapping.TestCase_81195, 'Success','Template created  and published Successfully','Server : Blade Server'])
            self.log_data( 'Successfully created  and published Template ')
            statausCreateTemplae = self.test_publishTemplate()
            
        else:
            self.log_TestData(["", "", "",str(self.tc_Id), testCaseDescriptionMapping.TestCase_81195, 'Failed','Failed to create/published template'])
    ...
    def test_publishTemplate(self):
        ...
        statausDeploy = False
        DeplName='TestCase_81195'
        deplyDesc=testCaseDescriptionMapping.TestCase_81195
