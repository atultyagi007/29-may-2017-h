...
class Testcase(TemplateTestBase,DiscoverResourceTestBase):
    """
    Baremetal deployment with Raid50 on H710 controller with hotspare1
    """ 
    ...
    def preRunSetup(self):
        ...
        servers = []
        serverType = serverPoolValue.TestCase_112205
    ...
    def test_createTemplate(self):
        ...
        self.setNetworkList()
        payload = self.readFile(globalVars.filename_TestCase_112205)
        self.getResources()
        networkType=inputForNetworkType.TestCase_112205_networkType
        if not networkType:
        ...
        if templateResponse.status_code in (200, 201, 202, 203, 204):
            ...
            self.log_TestData(["", "", "",str(self.tc_Id),testCaseDescriptionMapping.TestCase_112205, 'Success','Template created  and published Successfully','Server : Blade Server'])
            self.log_data( 'Successfully created  and published Template ')
            self.test_publishTemplate()
            
        else:
            self.log_TestData(["", "", "",str(self.tc_Id),testCaseDescriptionMapping.TestCase_112205, 'Failed','Failed to create/published template'])
    ...
    def test_publishTemplate(self):
        ...
        DeplName='TestCase_112205'
        deplyDesc=testCaseDescriptionMapping.TestCase_112205
