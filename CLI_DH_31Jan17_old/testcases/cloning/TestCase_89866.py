...
class Testcase(TemplateTestBase,DiscoverResourceTestBase):
    """
    Clone a VM from an ESX cluster to a different datacenter where the host doesnt include the workload network
    """ 
    ...
    def test_createTemplate(self):
        ...
        self.setNetworkList()
        payload = self.readFile(globalVars.filename_TestCase_89866)
        self.getResources()
    ...
    def test_publishTemplate(self):
        ...
        DeplName='TestCase_89866'
        deplyDesc='Deploy Clone a VM from an ESX cluster to a different datacenter where the host doesnt include the workload network'
