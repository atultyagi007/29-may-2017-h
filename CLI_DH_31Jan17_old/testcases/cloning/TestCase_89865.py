...
class Testcase(TemplateTestBase,DiscoverResourceTestBase):
    """
    Clone linux VM on ESX cluster on the same datacenter
    """ 
    ...
    def test_createTemplate(self):
        ...
        self.setNetworkList()
        payload = self.readFile(globalVars.filename_TestCase_89865)
        self.getResources()
    ...
    def test_publishTemplate(self):
        ...
        DeplName='TestCase_89865'
        deplyDesc='Deploy Clone linux VM on ESX cluster on the same datacenter'
