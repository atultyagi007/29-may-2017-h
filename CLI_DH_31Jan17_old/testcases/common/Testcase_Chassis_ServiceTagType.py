...
Note:For Server type is 'SERVER'
And for switch type is 'IOM'
'''
import os
import sys
    ...
    def runTestCase(self):
        ...
        if status and len(resDevice)> 0 :
            for chassisInfo in resDevice:
                serviceTag=chassisInfo['servers'][0]['serviceTag']
                managementIP = chassisInfo['servers'][0]['managementIP']
                refId = serviceTag+"/"+"SERVER"
                print managementIP
