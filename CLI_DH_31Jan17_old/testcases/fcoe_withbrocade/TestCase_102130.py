...
class Testcase(TemplateTestBase,DiscoverResourceTestBase):
    """
    Deploy 2 rack servers using ESX 5.1 with 2 Existing compellent  to a new cluster
    """ 
    ...
    def test_createTemplate(self):
        ...
        self.setNetworkList()
        payload = self.readFile(globalVars.filename_TestCase_102130)
        self.getResources()
        networkTypeServer1=inputForNetworkType.TestCase_102130_networkType_server1
        networkTypeServer2=inputForNetworkType.TestCase_102130_networkType_server2
        ...
        if templateResponse.status_code in (200, 201, 202, 203, 204):
            ...
            self.log_TestData(["", "", "", str(self.tc_Id),testCaseDescriptionMapping.TestCase_102130, 'Success','Template created  and published Successfully','Server : Rack Server'])
            self.log_data( 'Successfully created  and published Template ')
            self.test_publishTemplate()
            
        else:
            self.log_TestData(["", "", "", str(self.tc_Id),testCaseDescriptionMapping.TestCase_102130, 'Failed','Failed to create/published template'])
    ...
    def test_publishTemplate(self):
        ...
        DeplName='TestCase_102130'
        deplyDesc=testCaseDescriptionMapping.TestCase_102130
