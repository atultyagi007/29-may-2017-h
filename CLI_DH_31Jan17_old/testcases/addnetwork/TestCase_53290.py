...
class Testcase(TemplateTestBase,DiscoverResourceTestBase):
    """
    FC - On a successful HyperV deployment, scale up a network
    """ 
    tc_Id=""
    ...
    def test_createTemplate(self):
        ...
        payload = self.readFile(globalVars.filename_TestCase_53290)
        self.getResources()
        networkType=inputForNetworkType.TestCase_53290_networkType
        ...
        if not networkType:
            ...
            return
        if networkType=='FC_HyperV_2PORT':
            payload=payload.replace("$networkConfiguration",networkConfiguration.FC_HyperV_2PORT)
    ...
    def test_publishTemplate(self):
        ...
        DeplName='TestCase_53290'
        deplyDesc='FC - On a successful HyperV deployment, scale up a network'
                ...
                for res in cmpnt.findall('resources'):
                    for param in res.findall('parameters'):
                        if param.findtext('id') == 'network_configuration':
                            ...
                            netcon.text = networkConfiguration.Add_One_Network_FC_HyperV
