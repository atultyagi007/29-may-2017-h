...
class Testcase(TemplateTestBase,DiscoverResourceTestBase):
    """
    iS - EQL - On a successful HyperV deployment, scale up a network
    """ 
...
#             print " No BladeServers found "
    ...
    def test_createTemplate(self):
        ...
        payload = self.readFile(globalVars.filename_TestCase_53315)
        self.getResources()
        networkType=inputForNetworkType.TestCase_53315_networkType
        ...
        elif networkType=='Rack_ISCSI_EQL_2PORT_HYPERV':
            payload=payload.replace("$networkConfiguration",networkConfiguration.BladeHyperV_2Port)
        elif networkType=='Blade_ISCSI_EQL_2PORT_HYPERV':
    ...
    def test_publishTemplate(self):
        ...
        DeplName='TestCase_53315'
        deplyDesc= testCaseDescriptionMapping.TestCase_53315
        statausDeploy = False
