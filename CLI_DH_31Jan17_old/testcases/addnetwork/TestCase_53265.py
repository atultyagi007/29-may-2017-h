...
class Testcase(TemplateTestBase,DiscoverResourceTestBase):
    """
    iS - CO - Con - On a successful HyperV deployment, scale up a network
    """ 
    ...
    def test_createTemplate(self):
        ...
        self.setNetworkList()
        payload = self.readFile(globalVars.filename_TestCase_53265)
        self.getResources()
        
        networkTypeServer1=inputForNetworkType.TestCase_53265_networkType
...
#             return
        ...
        if templateResponse.status_code in (200, 201, 202, 203, 204):
            ...
            self.log_TestData(["", "", "",str(self.tc_Id), testCaseDescriptionMapping.TestCase_53265, 'Success','Template created  and published Successfully','Server : Blade Server'])
            self.log_data( 'Successfully created  and published Template ')
            statausCreateTemplae = self.test_publishTemplate()
            
        else:
            self.log_TestData(["", "", "",str(self.tc_Id), testCaseDescriptionMapping.TestCase_53265, 'Failed','Failed to create/published template'])
    ...
    def test_publishTemplate(self):
        ...
        statausDeploy = False
        DeplName='TestCase_53265'
        deplyDesc=testCaseDescriptionMapping.TestCase_53265
                ...
                for res in cmpnt.findall('resources'):
                    for param in res.findall('parameters'):
                        if param.findtext('id') == 'network_configuration':
                            ...
                            netcon.text = networkConfiguration.Add_One_Network_HyperV_Conv
