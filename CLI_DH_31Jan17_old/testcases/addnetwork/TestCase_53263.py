...
class Testcase(TemplateTestBase,DiscoverResourceTestBase):
    """
    iS - CO - Con - On a successful VMWare deployment, scale up a network.
    """ 
...
#         respCSP = self.cleanServerPool()
    ...
    def test_createTemplate(self):
        ...
        self.setNetworkList()
        payload = self.readFile(globalVars.filename_TestCase_53263)
        self.getResources()
        
        networkTypeServer1=inputForNetworkType.TestCase_53263_networkType
        ...
        elif networkTypeServer1=='Blade_ISCSICOMP_COV_ESXI_2PORT':
...
#             return
        ...
        if templateResponse.status_code in (200, 201, 202, 203, 204):
            ...
            self.log_TestData(["", "", "",str(self.tc_Id), testCaseDescriptionMapping.TestCase_53263, 'Success','Template created  and published Successfully','Server : Blade Server'])
            self.log_data( 'Successfully created  and published Template ')
            statausCreateTemplae = self.test_publishTemplate()
            
        else:
            self.log_TestData(["", "", "",str(self.tc_Id), testCaseDescriptionMapping.TestCase_53263, 'Failed','Failed to create/published template'])
    ...
    def test_publishTemplate(self):
        ...
        statausDeploy = False
        DeplName='TestCase_53263'
        deplyDesc=testCaseDescriptionMapping.TestCase_53263
                ...
                for res in cmpnt.findall('resources'):
                    for param in res.findall('parameters'):
                        if param.findtext('id') == 'network_configuration':
                            ...
                            netcon.text = networkConfiguration.Add_One_Network_Conv_Esxi
