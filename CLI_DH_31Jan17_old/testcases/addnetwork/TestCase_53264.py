...
class Testcase(TemplateTestBase,DiscoverResourceTestBase):
    """
    iS - CO - Div - On a successful HyperV deployment, scale up a network
    """ 
    ...
    def test_createTemplate(self):
        ...
        self.setNetworkList()
        payload = self.readFile(globalVars.filename_TestCase_53264)
        self.getResources()
        
        networkTypeServer1=inputForNetworkType.TestCase_53264_networkType
#         networkTypeServer2=inputForNetworkType.TestCase_126302_networkType_server2
        ...
        if not networkTypeServer1:
            ...
            return
        if networkTypeServer1=='Rack_ISCSICOMP_DIV_HYPERV_2PORT':
        ...
        elif networkTypeServer1=='Blade_ISCSICOMP_DIV_HYPERV_2PORT':
...
#             self.log_data( 'Please define the server and port type value in inputForNetworkType parameter file for this test case ')
#             return
#         if networkTypeServer2=='Rack_ISCSICOMP_DIV_HYPERV_2PORT':
...
#         elif networkTypeServer2=='Blade_ISCSICOMP_DIV_HYPERV_2PORT':
...
#             return
        ...
        if templateResponse.status_code in (200, 201, 202, 203, 204):
            ...
            self.log_TestData(["", "", "",str(self.tc_Id), testCaseDescriptionMapping.TestCase_53264, 'Success','Template created  and published Successfully','Server : Blade Server'])
            self.log_data( 'Successfully created  and published Template ')
            statausCreateTemplae = self.test_publishTemplate()
            
        else:
            self.log_TestData(["", "", "",str(self.tc_Id), testCaseDescriptionMapping.TestCase_53264, 'Failed','Failed to create/published template'])
    ...
    def test_publishTemplate(self):
        ...
        statausDeploy = False
        DeplName='TestCase_53264'
        deplyDesc=testCaseDescriptionMapping.TestCase_53264
...
#                             self.test_cleanDeployedTemplates(deploymentRefId)
    ...
    def ScaleUpNetwork(self,deploymentRefId):
        res,stat = self.getResponse("GET","Network")
        print " \n\n Network Configuration Before PUT : "
        print res
        netcon = ""
                ...
                for res in cmpnt.findall('resources'):
                    for param in res.findall('parameters'):
                        if param.findtext('id') == 'network_configuration':
                            ...
                            netcon.text = networkConfiguration.Add_One_Network_HyperV_Div
