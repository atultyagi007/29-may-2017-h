...
class test_102696(TemplateTestBase,DiscoverResourceTestBase):
    ...
    def getTearDownPayload(self,deploymentResponse):
        ...
        for st in root.findall('serviceTemplate'):
            for cmpnt in st.findall('components'):
                if cmpnt.findtext('type')=='SERVER' or cmpnt.findtext('type')=='STORAGE' or cmpnt.findtext('type')=='CLUSTER':
