...
'''
    # Test Case : Delete servers from a successful deployment
    # Pre-Requisite : successful deployment has storage and servers 
'''

class test_102698(TemplateTestBase,DiscoverResourceTestBase):
    ...
    def getServerTearDownPayload(self,deploymentResponse):
        logger = self.getLoggerInstance()
        ...
        canSupCl.text = 'true'
        canSupSrvr = root.find('canScaleupStorage')
        canSupSrvr.text = 'true'
