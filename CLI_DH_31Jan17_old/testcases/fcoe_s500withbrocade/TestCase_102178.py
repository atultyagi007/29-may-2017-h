...
class Testcase(TemplateTestBase,DiscoverResourceTestBase):
    """
    Deploy 2 rack servers using ESX 5.1 with 2 existing compellent volumes to a existing cluster
    """ 
...
#             print " No RackServers found of type : '%s'",str(serverType)
    ...
    def test_createTemplate(self):
        ...
        self.setNetworkList()
        payload = self.readFile(globalVars.filename_TestCase_102202)
        self.getResources()
    ...
    def test_publishTemplate(self):
        ...
        DeplName='TestCase_102178'
        deplyDesc='Deploy 2 rack servers using ESX 5.1 with 2 existing compellent volumes to a existing cluster'
