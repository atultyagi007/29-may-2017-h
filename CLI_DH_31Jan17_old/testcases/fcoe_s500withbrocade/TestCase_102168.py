...
class Testcase(TemplateTestBase,DiscoverResourceTestBase):
    """
    Deploy 2 blade servers using ESX 5.5 with 1 existing  compellent volume to a new cluster
    """ 
    ...
    def test_publishTemplate(self):
        ...
        DeplName='TestCase_102168'
        deplyDesc='Deploy 2 blade servers using ESX 5.5 with 1 existing compellent volume to a new cluster'
