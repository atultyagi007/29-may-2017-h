...
class Testcase(TemplateTestBase,DiscoverResourceTestBase):
    """
    Deploy 1 blade servers using ESX 5.5 with 1 compellent volume to a existing  cluster
    """ 
...
#             print " No BladeServers found of type : '%s'",str(serverType)
    ...
    def test_createTemplate(self):
        ...
        self.setNetworkList()
        payload = self.readFile(globalVars.filename_TestCase_102195)
        self.getResources()
    ...
    def test_publishTemplate(self):
        ...
        DeplName='TestCase_102171'
        deplyDesc='Deploy 1 blade servers using ESX 5.5 with 1 compellent volume to a existing  cluster'
