...
class Testcase(TemplateTestBase,DiscoverResourceTestBase):
    """
    Deploy 1 blade servers using ESX 5.1 with 1 compellent volume to a new cluster
    """ 
...
#             print " No BladeServers found of type : '%s'",str(serverType)
    ...
    def test_publishTemplate(self):
        ...
        DeplName='TestCase_102180'
        deplyDesc='Deploy 1 blade servers using ESX 5.1 with 1 compellent volume to a new cluster'
