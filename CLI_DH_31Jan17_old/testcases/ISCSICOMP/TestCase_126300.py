...
class Testcase(TemplateTestBase,DiscoverResourceTestBase):
    ...
    def test_createTemplate(self):
        ...
        self.setNetworkList()
        payload = self.readFile(globalVars.filename_TestCase_126300)
        self.getResources()
        
        networkTypeServer1=inputForNetworkType.TestCase_126300_networkType_server1
        networkTypeServer2=inputForNetworkType.TestCase_126300_networkType_server2
        ...
        if not networkTypeServer1:
            ...
            return
        if networkTypeServer1=='Rack_ISCSICOMP_COV_HYPERV_2PORT':
        ...
        elif networkTypeServer1=='Blade_ISCSICOMP_COV_HYPERV_2PORT':
        ...
        if not networkTypeServer2:
            ...
            self.log_data( 'Please define the server and port type value in inputForNetworkType parameter file for this test case ')
            return
        if networkTypeServer2=='Rack_ISCSICOMP_COV_HYPERV_2PORT':
        ...
        elif networkTypeServer2=='Blade_ISCSICOMP_COV_HYPERV_2PORT':
        ...
        if templateResponse.status_code in (200, 201, 202, 203, 204):
            ...
            self.log_TestData(["", "", "",str(self.tc_Id), testCaseDescriptionMapping.TestCase_126300, 'Success','Template created  and published Successfully','Server : Blade Server'])
            self.log_data( 'Successfully created  and published Template ')
            statausCreateTemplae = self.test_publishTemplate()
            
        else:
            self.log_TestData(["", "", "",str(self.tc_Id), testCaseDescriptionMapping.TestCase_126300, 'Failed','Failed to create/published template'])
    ...
    def test_publishTemplate(self):
        ...
        statausDeploy = False
        DeplName='TestCase_126300'
        deplyDesc=testCaseDescriptionMapping.TestCase_126300
