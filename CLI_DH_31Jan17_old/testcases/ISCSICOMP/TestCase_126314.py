...
class Testcase(TemplateTestBase,DiscoverResourceTestBase):
    ...
    def test_createTemplate(self):
        ...
        payload = self.readFile(globalVars.filename_TestCase_126314_before_scaleup)
        self.getResources()
        
        networkTypeServer1=inputForNetworkType.TestCase_126314_networkType_server1
        networkTypeServer2=inputForNetworkType.TestCase_126314_networkType_server2
    ...
    def test_publishTemplate(self):
        ...
        DeplName='TestCase_126314'
        deplyDesc=testCaseDescriptionMapping.TestCase_126314
    ...
    def test_scaleUpTemplate(self, templateID, deploymentRefId, DeplName, deplyDesc):
        ...
        payload = self.readFile(globalVars.filename_TestCase_126314_afte_scaleup_App)
        network_Type = inputForNetworkType.TestCase_126314_scaleUp_networkType
        if not network_Type:
