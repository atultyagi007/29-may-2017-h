...
class Testcase(TemplateTestBase,DiscoverResourceTestBase):
    ...
    def test_createTemplate(self):
        ...
        payload = self.readFile(globalVars.filename_TestCase_126317_before_scaleup)
        self.getResources()
        
        networkTypeServer1=inputForNetworkType.TestCase_126317_networkType_server1
        networkTypeServer2=inputForNetworkType.TestCase_126317_networkType_server2
        ...
        if templateResponse.status_code in (200, 201, 202, 203, 204):
            ...
            self.log_TestData(["", "", "", str(testCaseID), testCaseDescriptionMapping.TestCase_126317, 'Success','Template created  and published Successfully','Server : Blade Server'])
            self.test_publishTemplate()
            
        else:
            self.log_TestData(["", "", "", str(testCaseID),testCaseDescriptionMapping.TestCase_126317, 'Failed','Failed to create/published template'])
    ...
    def test_publishTemplate(self):
        ...
        DeplName='TestCase_126317'
        deplyDesc=testCaseDescriptionMapping.TestCase_126317
    ...
    def test_scaleUpTemplate(self, templateID, deploymentRefId, DeplName, deplyDesc):
        ...
        payload = self.readFile(globalVars.filename_TestCase_126317_afte_scaleup_Server)
        network_Type = inputForNetworkType.TestCase_126317_scaleUp_networkType
        if not network_Type:
