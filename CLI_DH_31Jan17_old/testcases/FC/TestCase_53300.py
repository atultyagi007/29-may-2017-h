...
class Testcase(TemplateTestBase,DiscoverResourceTestBase):
    """
    On a successful HyperV deployment and scale up an application.
    """ 
    ...
    def test_createTemplate(self):
        ...
        payload = self.readFile(globalVars.filename_TestCase_53300)
        self.getResources()
        networkType=inputForNetworkType.TestCase_53300_networkType
    ...
    def test_publishTemplate(self):
        ...
        DeplName='TestCase_53300'
        deplyDesc='On a successful HyperV deployment and scale up an app '
    ...
    def test_scaleUpTemplate(self, templateID, deploymentRefId, DeplName, deplyDesc):
        logger = self.getLoggerInstance()
        testCaseID=self.getTestCaseID(__file__)
        payload = self.readFile(globalVars.filename_TestCase_53300_scaleup_app)
