...
class Testcase(TemplateTestBase,DiscoverResourceTestBase):
    ...
    def test_createTemplate(self):
        ...
        payload = self.readFile(globalVars.filename_TestCase_53292)
        self.getResources()
        networkType=inputForNetworkType.TestCase_53292_networkType
    ...
    def test_publishTemplate(self):
        ...
        DeplName='TestCase_53292'
        deplyDesc='End to end deployment with compellent stoage, HyperV host, Hyperv cluster, VMs and application'
