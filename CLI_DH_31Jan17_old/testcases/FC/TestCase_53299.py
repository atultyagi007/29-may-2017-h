...
class Testcase(TemplateTestBase,DiscoverResourceTestBase):
    """
    On a successful HyperV deployment and scale up an VM.
    """ 
    ...
    def test_createTemplate(self):
        ...
        payload = self.readFile(globalVars.filename_TestCase_53299)
        self.getResources()
        networkType=inputForNetworkType.TestCase_53299_networkType
    ...
    def test_publishTemplate(self):
        ...
        DeplName='TestCase_53299'
        deplyDesc='On a successful HyperV deployment and scale up an VM'
    ...
    def test_scaleUpTemplate(self, templateID, deploymentRefId, DeplName, deplyDesc):
        logger = self.getLoggerInstance()
        testCaseID=self.getTestCaseID(__file__)
        payload = self.readFile(globalVars.filename_TestCase_53299_scaleup_vm)
