...
'''
    script for parallel execution of FCOE_NO_brocade cases
'''
...
class Testcase_parallel(TemplateTestBase,DiscoverResourceTestBase):
    ...
    def run_Thread_1(self):
        ...
        test1 = TestCase_102142.Testcase()
        test1.test_createTemplate()
        test2 = TestCase_102144.Testcase()
        test2.test_createTemplate()
        test3 = TestCase_102145.Testcase()
        test3.test_createTemplate()
        
        
    def run_Thread_2(self):
        print threading.currentThread().getName(), 'Starting.......'
        test4 = TestCase_102147.Testcase()
        test4.test_createTemplate()
        test5 = TestCase_102154.Testcase()
        test5.test_createTemplate()
        test6 = TestCase_102156.Testcase()
        test6.test_createTemplate()
                
    def run_Thread_3(self):
        test7 = TestCase_102157.Testcase()
        test7.test_createTemplate()
        test8 = TestCase_102159.Testcase()
...
if __name__ == "__main__":
    try:
        ...
        threading.local()
        t1 = threading.Thread(name='FCOENOBrocade_Thread_1',target=test.run_Thread_1)
        t2 = threading.Thread(name='FCOENOBrocade_Thread_2',target=test.run_Thread_2)
        t3 = threading.Thread(name='FCOENOBrocade_Thread_3',target=test.run_Thread_3)
        t1.start()
        t2.start()
        t3.start()
