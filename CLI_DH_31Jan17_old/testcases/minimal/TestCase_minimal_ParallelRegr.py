...
'''
    Regression script for parallel execution of Minimal test cases
'''
class Testcase_parallel(TemplateTestBase,DiscoverResourceTestBase):
    ...
    def run_Thread_1(self):
        ...
        test1 = TestCase_107285.Testcase()
        test1.test_createTemplate()
        test2 = TestCase_107286.Testcase()
        test2.test_createTemplate()
        test3 = TestCase_107287.Testcase()
        test3.test_createTemplate()
        
        
    def run_Thread_2(self):
        print threading.currentThread().getName(), 'Starting.......'
        test4 = TestCase_107442.Testcase()
        test4.test_createTemplate()
        test5 = TestCase_107443.Testcase()
        test5.test_createTemplate()
        test6 = TestCase_107444.Testcase()
        test6.test_createTemplate()
                
    def run_Thread_3(self):
        test17 = TestCase_107445.Testcase()
        test17.test_createTemplate()
        test18 = TestCase_107446.Testcase()
        test18.test_createTemplate()
        test19 = TestCase_107447.Testcase()
        test19.test_createTemplate()
        
    def run_Thread_4(self):
        test20 = TestCase_107448.Testcase()
        test20.test_createTemplate()
        test21 = TestCase_107449.Testcase()
        test21.test_createTemplate()
        test22 = TestCase_107450.Testcase()
        test22.test_createTemplate()
        test23 = TestCase_109194.Testcase()
...
if __name__ == "__main__":
    try:
        ...
        threading.local()
        t1 = threading.Thread(name='Minimal_Thread_1',target=test.run_Thread_1)
        t2 = threading.Thread(name='Minimal__Thread_2',target=test.run_Thread_2)
        t3 = threading.Thread(name='Minimal__Thread_3',target=test.run_Thread_3)
        t4 = threading.Thread(name='Minimal__Thread_4',target=test.run_Thread_4)
        t1.start()
        t2.start()
        t3.start()
        t4.start()
