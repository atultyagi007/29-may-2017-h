...
Description: Baremetal Deployment with Windows + Application/Adding Validation
'''
...
class Testcase(Manager.Manager): 
    """
    Baremetal Deployment with Windows & Application
    """
    ...
    def preRunSetup(self):
        ...
        fileName = globalVars.jsonMap["baremetalWINDOWS"]        
