...
@author: raj.patel
Description:On the "Summary" page, verify that all entries including mouseovers are correct.(cluster is yes, but servers report not in inventory, and storage reports not managed and attached server not managed
...
class Testcase(Manager.Manager): 
    """
     Brownfield -cluster is yes, but servers report not in inventory, and storage reports not managed and attached server not managed
    """
...
#         List of Server ip
        ...
        self.resourceIPList = self.resourceIPList1 + self.resourceIPList3
