...
@author: raj.patel
Description:This test case covers adding a firmware catalog to a brownfield service during discovery.
'''
...
class Testcase(Manager.Manager): 
    """
     Brownfield - Firmware Compliance during discovery
    """
    ...
    def runTestCase(self):
        ...
        self.brownFieldServiceSchanario(self.brownFieldServiceName, self.brownFieldCompName, self.targetVirtualMachineServiceTag, self.dataCenterName, self.clusterName, storageDiscov=self.storageDiscov, serverDiscov=self.serverDiscov, serverState=self.serverState, storageState = self.storageState,addfirmware=self.addfirmware)
...
#         List of Server ip
        ...
        self.brownFieldServiceName = "BrownFieldServiceTest1"
        self.brownFieldCompName = "BrownFieldClstr1"
