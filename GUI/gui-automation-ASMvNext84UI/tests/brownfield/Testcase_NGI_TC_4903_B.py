...
@author: raj.patel
Description:On the "Summary" page, verify that all entries including mouseovers are correct.(cluster is yes, but servers not in inventory, and storage reports attached server not in inventory.
...
class Testcase(Manager.Manager): 
    """
     Brownfield -cluster is yes, but servers not in inventory, and storage reports attached server not in inventory
    """
    ...
    def preRunSetup(self):
        ...
        self.discoverResource_Type("Storage", "172.31.32.108", "172.31.32.108", "Managed","", "autoStorageEQL", "", "","", "")
