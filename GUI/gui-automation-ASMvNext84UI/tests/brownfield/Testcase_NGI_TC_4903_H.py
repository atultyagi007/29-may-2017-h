...
@author: raj.patel
Description:On the "Summary" page, verify that all entries including mouseovers are correct.(cluster and servers are yes, but storage reports not managed
...
class Testcase(Manager.Manager): 
    """
     Brownfield -cluster and servers are yes, but storage reports not managed
    """
...
#                 self.discoverResource_Type("Chassis", resourceIP, resourceIP, "Managed","Dell PowerEdge iDRAC Default", "", "Dell chassis default", "","Dell switch default", "")
        ...
        self.changeResourceState(self.resourceIPList1)
    ...
    def postRunCleanup(self):
        ...
        self.changeResourceState(self.resourceIPList1,resourceState="Managed")
        self.logout()
