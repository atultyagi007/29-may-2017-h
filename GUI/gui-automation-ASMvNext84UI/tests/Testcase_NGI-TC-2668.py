...
Description: Verify that while creating a template, the Admin can select specific Standard users to grant access to
'''
...
class Testcase(Manager.Manager): 
    """
    While creating a template, the Admin can select specific Standard users to grant access to
    """
