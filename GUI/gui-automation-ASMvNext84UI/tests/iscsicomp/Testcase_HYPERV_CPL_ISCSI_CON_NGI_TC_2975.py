...
Description: iS - CO - Con - End to end deployment with compellent stoage, HyperV host, Hyperv cluster, VMs and application.
Covered test cases 2975,2988,2987,2978,3073,3389.
'''
...
class Testcase(Manager.Manager): 
    """
    iS - CO - Con - End to end deployment with compellent stoage, HyperV host, Hyperv cluster, VMs and application.
    """
    ...
    def preRunSetup(self):
        ...
        fileName = globalVars.jsonMap["hyperVcpliscsi"]        
