...
Description: iS - CO - Div - End to end deployment with compellent stoage, ESXi host, VMWare cluster, VMs and application.
Covered test cases 2976,2989,2981,2973,2993.
'''
...
class Testcase(Manager.Manager): 
    """
    iS - CO - Div - End to end deployment with compellent stoage, ESXi host, VMWare cluster, VMs and application.
    """
    ...
    def preRunSetup(self):
        ...
        fileName = globalVars.jsonMap["esxicpliscsiDiver"]        
