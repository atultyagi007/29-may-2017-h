...
Description: iS - CO - Div - End to end deployment with compellent stoage, HyperV host, Hyperv cluster, VMs and application..
2982,2986,2984,2992,2974,3072,3390.
'''
...
class Testcase(Manager.Manager): 
    """
    iS - CO - Div - End to end deployment with compellent stoage, HyperV host, Hyperv cluster, VMs and application..
    """
    ...
    def preRunSetup(self):
        ...
        fileName = globalVars.jsonMap["hyperVcpliscsiDiver"]        
