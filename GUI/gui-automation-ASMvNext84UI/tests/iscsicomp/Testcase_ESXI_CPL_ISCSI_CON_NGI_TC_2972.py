...
Description: iS - CO - Con - End to end deployment with compellent stoage, ESXi host, VMWare cluster, VMs and application.
Covered test case 2972,2990,2991,2983,2977,3071.
'''
...
class Testcase(Manager.Manager): 
    """
    iS - CO - Con - End to end deployment with compellent stoage, ESXi host, VMWare cluster, VMs and application.
    """
    ...
    def preRunSetup(self):
        ...
        fileName = globalVars.jsonMap["esxicpliscsi"]        
