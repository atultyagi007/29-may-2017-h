...
Description: iS - CO - Con - End to end deployment with compellent stoage, ESXi host, VMWare cluster with VDS
...
class Testcase(Manager.Manager): 
    """
    iS - CO - Con - End to end deployment with compellent stoage, ESXi host, VMWare cluster with VDS
    """
    ...
    def runTestCase(self):
        ...
        self.executeCompleteFlow(self.templateName, self.storageType, self.storageName, self.volumeName, targetStorage="200358", flowType="converge")
    ...
    def test_functionality(self):        
        ...
        self.templateName= "Exsi_Con_CO_"+currentTime
