...
Description: Deploy ESXi EqualLogic Converged workflow with Baremetal
'''
...
class Testcase(Manager.Manager): 
    """
    Deploy ESXi EqualLogic Converged workflow with Baremetal
    """
    ...
    def preRunSetup(self):
        ...
        fileName = globalVars.jsonMap["baremetaladdon"]        
