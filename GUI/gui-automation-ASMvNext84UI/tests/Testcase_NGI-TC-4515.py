...
Description: Add an EMC storage device, Resource State = 'unmanaged'. Device info will be read from config/Input.xlsx.
'''
...
#        self.deleteCredential(credential["Name"], True)
        ...
        resource["Resource State"] = "Unmanaged"
        ...
        self.changeResourceState([globalVars.deviceId], originalResourceState)
