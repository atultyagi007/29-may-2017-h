...
Description: Verify that for each service on the Services page, the Standard user is not able to Update Firmware.
"""
...
class Testcase(Manager.Manager): 
    """
    For each service, Standard user unable to Update Firmware.
    """
    ...
    def runTestCase(self):
        ...
        #Verify Options
        self.getServiceOptions(actualOptions=["Export to File", "View Details", "Update Firmware"], disableOptions=["Update Firmware"], serviceName=self.serviceName)
