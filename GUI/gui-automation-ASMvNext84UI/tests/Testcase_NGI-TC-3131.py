...
Description: Import AD users and assign Admin user role
Test Flow    : 1) Login as admin.
               2) Navigate to Users page and create a new directory.
               3) Import the user and assign Admin Role
...
class Testcase(Manager.Manager): 
    """
    Import AD users and assign Admin user role
    """
