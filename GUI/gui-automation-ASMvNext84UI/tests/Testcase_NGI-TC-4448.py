...
Test-Case: NGI-TC-4448 HyperV with iSCSI Compellent deployment with static networks for server
...
class Testcase(Manager.Manager): 
    """
    Description: ASM-4359: Specify Manual Static IPs for Networking during Deployment/NGI-TC-4448 HyperV with iSCSI Compellent deployment with static networks for server
    """
