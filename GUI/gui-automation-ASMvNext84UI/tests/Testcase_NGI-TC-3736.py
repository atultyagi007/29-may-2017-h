...
Description: Baremetal Deployment with CentOS + Application + Post OS NIC Teaming (4-Port)/Adding Validation
'''
...
class Testcase(Manager.Manager): 
    """
    Baremetal Deployment with CentOS & Application & Post OS NIC Teaming
    """
    ...
    def preRunSetup(self):
        ...
        #Change Network Type
        self.components["Server"]["Networks"] = "BAREMETAL_LINUX_4_TEAMING"
