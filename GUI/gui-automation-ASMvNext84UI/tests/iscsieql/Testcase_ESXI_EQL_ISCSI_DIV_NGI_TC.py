...
Description: iS - EQL - Div - End to end deployment with equallogic stoage, ESXi host, VMWare cluster, VMs and application.
Covered test cases 3708,3700,3707,3715,3712,3714,3715,3703.
'''
...
class Testcase(Manager.Manager): 
    """
    iS - EQL - Div - End to end deployment with equallogic stoage, ESXi host, VMWare cluster, VMs and application..
    """
    ...
    def preRunSetup(self):
        ...
        fileName = globalVars.jsonMap["esxieqliscsiDiver"]        
