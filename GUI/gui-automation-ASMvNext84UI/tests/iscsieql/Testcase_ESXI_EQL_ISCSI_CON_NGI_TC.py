...
Description: iS - EQL - End to end deployment for equallogic stoage, ESXi host, VMWare cluster, VMs and application.
Covered the test cases 3074,3090,3086,3091,3092,3080,3083.
'''
...
class Testcase(Manager.Manager): 
    """
    iS - EQL - End to end deployment for equallogic stoage, ESXi host, VMWare cluster, VMs and application.
    """
    ...
    def preRunSetup(self):
        ...
        json_file="ESXI_EQL_ISCSI_Converged.json"     
