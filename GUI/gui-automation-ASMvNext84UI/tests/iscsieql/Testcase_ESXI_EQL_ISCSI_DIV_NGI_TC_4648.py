...
Description: iS - EQL - Div - End to end deployment with DRS enable equallogic stoage, ESXi host, VMWare cluster, VMs and application.
'''
...
class Testcase(Manager.Manager): 
    """
    iS - EQL - Div - End to end deployment with DRS enabled equallogic stoage, ESXi host, VMWare cluster, VMs and application..
    """
    ...
    def preRunSetup(self):
        ...
        json_file="ESXI_EQL_ISCSI_Diverged_4648.json"     
