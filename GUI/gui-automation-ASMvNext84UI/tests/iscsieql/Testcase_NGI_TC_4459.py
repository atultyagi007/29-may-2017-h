...
Description: End-to-end deployment with storage, vmware server, esxi cluster, and CentOS VM with Applications
'''
...
class Testcase(Manager.Manager): 
    """
    End-to-end deployment with storage, vmware server, esxi cluster, and CentOS VM with Applications
    """
    ...
    def preRunSetup(self):
        ...
        json_file="ESXI_EQL_CentosVM_4459.json"     
