...
Description: iS - EQL - Div - End to end deployment with equallogic storage, HyperV host, Hyperv cluster, VMs and application.
Covered test cases 3704,3699,3713,3701,3702,3710.
'''
...
class Testcase(Manager.Manager): 
    """
    iS - EQL - Div - End to end deployment with equallogic storage, HyperV host, Hyperv cluster, VMs and application..
    """
    ...
    def preRunSetup(self):
        ...
        fileName = globalVars.jsonMap["hyperVeqliscsiDiver"]        
