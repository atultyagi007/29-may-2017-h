...
Description: iS - EQL - Div - End to end deployment with mem enable equallogic stoage, ESXi host, VMWare cluster, VMs and application.
'''
...
class Testcase(Manager.Manager): 
    ...
    def preRunSetup(self):
        ...
        json_file="ESXI_EQL_ISCSI_Diverged_3705.json"     
