...
Description: iS - EQL - End to end deployment with MEM enabled for equallogic stoage, ESXi host, VMWare cluster, VMs and application.
'''
...
class Testcase(Manager.Manager): 
    """
    iS - EQL - End to end deployment with MEM enabled for equallogic stoage, ESXi host, VMWare cluster, VMs and application.
    """
    ...
    def preRunSetup(self):
        ...
        json_file="ESXI_EQL_ISCSI_Conv_3145.json"     
