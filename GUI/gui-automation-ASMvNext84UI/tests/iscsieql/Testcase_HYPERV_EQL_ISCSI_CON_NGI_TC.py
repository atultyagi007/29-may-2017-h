...
Description: iS - EQL - End to end deployment with equallogic storage, HyperV host, Hyperv cluster, VMs and application.
Covered test cases 3085,3089,3076,3078,3123,3338.
'''
...
class Testcase(Manager.Manager): 
    """
    iS - EQL - End to end deployment with equallogic storage, HyperV host, Hyperv cluster, VMs and application.
    """
    ...
    def preRunSetup(self):
        ...
        fileName = globalVars.jsonMap["hyperVeqliscsi"]        
