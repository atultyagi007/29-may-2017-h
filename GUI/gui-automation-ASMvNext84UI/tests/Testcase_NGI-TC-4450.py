...
Test-Case: NGI-TC-4450 HyperV with iSCSI Compellent Diverged deployment with static networks for server
...
class Testcase(Manager.Manager): 
    """
    Description: ASM-4359: Specify Manual Static IPs for Networking during Deployment/NGI-TC-4450 HyperV with iSCSI Compellent Diverged deployment with static networks for server
    """
    ...
    def preRunSetup(self):
        ...
        #Read JSON
        fileName = globalVars.jsonMap["hypervcplstatic"]        
        ...
        #Edit Template Name
        self.components["Template"]["Name"] = "Template_HYPERV_CPL_Diverged_StaticIP" 
            
        #Change Network Type
        self.components["Server"]["Networks"] = "HYPERV_CPL_ISCSI_DIVERGED_2"
