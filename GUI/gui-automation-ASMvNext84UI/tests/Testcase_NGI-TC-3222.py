...
class Testcase(Manager.Manager): 
    ...
    def runTestCase(self):
        ...
        self.getTemplateOptions(actualOptions=["Edit","View Details", "Clone", "Delete", "Delete Template"], 
                disableOptions=["Delete", "Delete Template"], templateName=tempList[0]["Name"], templateType="Sample Templates", templateDetailOptions=True)
        self.succeed("Delete Option is Disabled for Sample Template :: '%s'"%tempList[0]["Name"])
