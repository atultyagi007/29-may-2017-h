...
Description: BAREMETAL LINUX deployment with PXE and Static Private Workload.
'''
...
class Testcase(Manager.Manager): 
    """
    BAREMETAL LINUX deployment with PXE and Static Private Workload.
    """
    ...
    def preRunSetup(self):
        ...
        fileName = "BAREMETAL_LINUX_4423.json"      
    ...
    def runTestCase(self):
        ...
        for network in networkConfig:
            if network["Name"]=="autoPXE":
                ...
                expectedUntaggedVlans.append(int(network["VLANID"]))
            elif network["Name"]=="autpPrivateLAN":
                expectedTaggedVlans.append(network["VLANID"])
