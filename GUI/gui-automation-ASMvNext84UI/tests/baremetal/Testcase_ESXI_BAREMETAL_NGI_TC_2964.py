...
Description: All servers in the pool fail (server pool consists of different type of servers).
'''
...
class Testcase(Manager.Manager): 
    """
    All servers in the pool fail (server pool consists of different type of servers)
    """
...
#         fileName = globalVars.jsonMap["bareMetalexsi"]
        fileName = "BAREMETAL_LINUX_2964.json"        
