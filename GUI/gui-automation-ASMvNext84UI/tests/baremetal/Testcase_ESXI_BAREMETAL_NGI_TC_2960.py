...
Description: Some servers in the pool fail (server pool consists of different generations of same type servers).
'''
...
class Testcase(Manager.Manager): 
    """
    Some servers in the pool fail (server pool consists of different generations of same type servers)
    """
...
#         fileName = globalVars.jsonMap["bareMetalexsi"]
        fileName = "BAREMETAL_LINUX_2960.json"        
