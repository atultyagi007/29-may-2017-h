...
Description: Deploy a service with Windows Bare Metal with Applications.
'''
...
class Testcase(Manager.Manager): 
    """
    Windows Baremetal deployment with Applications
    """
    ...
    def preRunSetup(self):
        ...
        fileName = "BAREMETAL_WINDOWS_4455.json"      
