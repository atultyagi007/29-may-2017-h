...
Description: All servers in the pool fail (server pool consists of same type of servers) - deployment to Local Hard drive.
'''
...
class Testcase(Manager.Manager): 
    """
    All servers in the pool fail (server pool consists of same type of servers)
    """
...
#         fileName = globalVars.jsonMap["bareMetalexsi"]
        fileName = "BAREMETAL_LINUX_2961.json"        
