...
Description: Deploy a service with Linux RedHat Bare Metal with Applications.
'''
...
class Testcase(Manager.Manager): 
    """
    Linux RedHat Baremetal deployment with Applications
    """
    ...
    def preRunSetup(self):
        ...
        fileName = "BAREMETAL_ESXI_RHEL_4478.json"      
