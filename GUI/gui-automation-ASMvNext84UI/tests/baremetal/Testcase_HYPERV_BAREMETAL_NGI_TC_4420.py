...
Description: Bare metal WIndows deployment with PXE and Public DHCP Workload networks on the same .
'''
...
class Testcase(Manager.Manager): 
    """
    Bare metal WIndows deployment with PXE and Public DHCP Workload networks on the same 
    """
    ...
    def preRunSetup(self):
        ...
        fileName = globalVars.jsonMap["bareMetalwindos"]        
