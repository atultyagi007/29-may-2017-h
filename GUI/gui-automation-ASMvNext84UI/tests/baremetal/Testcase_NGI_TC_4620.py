...
Description: Deploy a service with SLES Bare Metal with Applications.
'''
...
class Testcase(Manager.Manager): 
    """
    Baremetal deployment with SLES OS, scaleup Applications
    """
    ...
    def preRunSetup(self):
        ...
        fileName = "BAREMETAL_SLES_4620.JSON"      
