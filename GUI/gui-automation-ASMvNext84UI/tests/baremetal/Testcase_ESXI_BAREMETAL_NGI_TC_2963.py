...
Description: All servers in the pool fail (server pool consists of only 1 server).
'''
...
class Testcase(Manager.Manager): 
    """
    All servers in the pool fail (server pool consists of only 1 server)
    """
...
#         fileName = globalVars.jsonMap["bareMetalexsi"]
        fileName = "BAREMETAL_LINUX_2963.json"        
