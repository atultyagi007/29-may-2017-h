...
Test-Case: NGI-TC-4449 HyperV with iSCSI EQL deployment with static networks for server
...
class Testcase(Manager.Manager): 
    """
    Description: ASM-4359: Specify Manual Static IPs for Networking during Deployment/NGI-TC-4449 HyperV with iSCSI EQL deployment with static networks for server
    """
