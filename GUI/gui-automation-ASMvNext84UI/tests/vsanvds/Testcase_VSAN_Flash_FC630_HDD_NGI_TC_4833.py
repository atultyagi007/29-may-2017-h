...
@author: rajeev.kumar
Description:VSAN Deployment on FC 630 - all flash  Boot to HDD instead of SD card
...
class Testcase(Manager.Manager): 
    """
VSAN Deployment on FC 630 - all flash  Boot to 2-HDD 
    """
    ...
    def preRunSetup(self):
        ...
        fileName = "VSAN_flash_2HDD_4833.json"      
