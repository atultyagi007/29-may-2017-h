...
Description: VSAN deployment with VDS enabled and deploy to HDD - Clone from Default VSAN template
'''
...
class Testcase(Manager.Manager): 
    """
    VSAN deployment with VDS enabled and deploy to HDD - Clone from Default VSAN template
    """
...
#         tempList = self.getTemplates(option="My Templates")
        ...
        self.cloneTemplateName = self.templateName.split('_clone',1)
        self.cloneTemplateName = self.cloneTemplateName[0]
...
#             self.createServerPool(self.components)
        ...
        self.cloneTemplate(self.cloneTemplateName, "Sample Templates")
        self.buildTemplate(self.components, publishTemplate=True, editClone= True)
        #Deploy Service
        #=======================================================================
