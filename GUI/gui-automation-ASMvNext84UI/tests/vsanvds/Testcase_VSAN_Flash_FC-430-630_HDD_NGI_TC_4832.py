...
@author: rajeev.kumar
Description:VSAN Deployment on FC 430 and FC 630 - all flash  Boot to HDD instead of SD card
           merged testcases:
           NGI-TC-4834--Scale up a server and VM on FC 430 and FC 630 deployments.
'''
...
class Testcase(Manager.Manager): 
    """
VSAN Deployment on FC 430 and FC 630 - all flash  Boot to HDD instead of SD card
    """
    ...
    def preRunSetup(self):
        ...
        fileName = "VSAN_VDS_FC-430-630_HDD_4832.json"      
