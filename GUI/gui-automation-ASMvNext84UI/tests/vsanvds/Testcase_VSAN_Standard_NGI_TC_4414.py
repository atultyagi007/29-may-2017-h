...
Description: VSAN deployment with Standard switch -  R630, R 730 and R730XD
             Teardown of service after successful deployment
             merge Testcases:
             Testcase_NGI_TC_4415 
'''
...
class Testcase(Manager.Manager): 
    """
    VSAN deployment with Standard switch -  R630, R 730 and R730XD
    """
    ...
    def preRunSetup(self):
        ...
        fileName = "VSAN_standard_4414.json"       
    ...
    def runTestCase(self):
        ...
        self.getVcenterDetailsMng(self.components)
        #teardown deployment
