...
@author: rajeev.kumar
Description:VSAN deployment with VDS enabled using the HBA 330 controller - R730,R630. SD boot.
            merged testcsaes:
             NGI-TC-4813--Teardown a VSAN deployment with VDS enabled. 
             NGI-TC-4811--Server and VM scale up on a VSAN VDS deployment
             NGI-TC---Scale up a static Network on VDS VSAn deployement (Host and VM level)
'''
...
class Testcase(Manager.Manager): 
    """
    VSAN deployment with VDS enabled using the HBA 330 controller- R630 &730 with SD card. 
    """
    ...
    def preRunSetup(self):
        ...
        fileName = "VSAN_4810_flash_HBA.json"      
