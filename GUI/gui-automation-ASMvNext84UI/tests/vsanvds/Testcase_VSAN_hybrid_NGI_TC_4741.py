...
Description: Kick off a VSAN deployment with boot to SD card. We use the X710 and X540 NICS on an R630 Server. with HBA 730.
'''
...
class Testcase(Manager.Manager): 
    ...
    def preRunSetup(self):
        ...
        fileName = "VSAN_hybrid_4741.json"      
