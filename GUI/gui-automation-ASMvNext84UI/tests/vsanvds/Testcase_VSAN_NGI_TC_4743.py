...
Description: Kick off a deployment with FC 630 follwoing the FC 430 deployment using the same storage policy.
...
class Testcase(Manager.Manager): 
    """
    Kick off a deployment with FC 630 follwoing the FC 430 deployment using the same storage policy.
    """
    ...
    def preRunSetup(self):
        ...
        fileName = "VSAN_testcase_4743.json"      
