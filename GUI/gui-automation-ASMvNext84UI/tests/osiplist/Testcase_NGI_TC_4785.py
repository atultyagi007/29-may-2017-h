...
Description: Deploy End to End deployment with New Vms, ESXi.Separate deployments.
           Prerequisites:Define more than 5 LAN(33,34,35,53,41,43). 
'''
...
class Testcase(Manager.Manager): 
    """
    Deploy End to End deployment with New Vms, ESXi.Separate deployments
    """
    ...
    def preRunSetup(self):
        ...
        fileName = "ESXI_EQL_Conv_4785.json"      
