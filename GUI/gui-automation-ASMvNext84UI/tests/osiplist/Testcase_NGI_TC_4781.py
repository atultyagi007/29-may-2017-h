...
Description: Create new deployment with end to end with storage, server, cluster and vm. (ESXI). 
             Verify VM has correct static ip.
             1:NGI-TC-4783 test case merged.
'''
...
class Testcase(Manager.Manager): 
    """
    Create new deployment with end to end with storage, server, cluster and vm. (ESXI)
    """
    ...
    def preRunSetup(self):
        ...
        fileName = "ESXI_EQL_Conv_4781.json"      
