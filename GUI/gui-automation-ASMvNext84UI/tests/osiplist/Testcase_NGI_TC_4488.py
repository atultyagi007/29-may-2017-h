...
Description: scaleup server and use static IP for hypervisor mgmt network.
'''
...
class Testcase(Manager.Manager): 
    """
    scaleup server and use static IP for hypervisor mgmt network
    """
    ...
    def runTestCase(self):
        ...
        self.deployService(self.templateName, serviceName=self.serviceName, staticIP=True, retryOnFailure=self.retryOnFailure)
...
#         #=======================================================================
        ...
        if (globalVars.staticIP != ""):
            globalVars.staticIP = self.components["Scaleup"]["Deployment"]["StaticIP"]
        self.scaleUpService(self.serviceName, self.components,staticIP=True)
