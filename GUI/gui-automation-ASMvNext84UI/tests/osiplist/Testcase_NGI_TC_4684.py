...
Description: Baremetal Windows with Static IP. 
'''
...
class Testcase(Manager.Manager): 
    """
    Baremetal Windows with Static IP
    """
    ...
    def preRunSetup(self):
        ...
        fileName = "BAREMETAL_WINDOWS_4684.json"      
...
#         Deploy Service
        ...
        result = self.getDeploymentStatus("Service_Template_Baremetal_windows_4684", deleteStatus=False, timeout=10800, waitTime=300)
        if len(result) > 0:
