...
Description: enter an IP that is part of the same deployment.
'''
...
class Testcase(Manager.Manager): 
    """
    enter an IP that is part of the same deployment
    """
    ...
    def runTestCase(self):
        ...
        self.deployService(self.serviceName, serviceName=self.serviceName, staticIP=True, retryOnFailure=self.retryOnFailure)
