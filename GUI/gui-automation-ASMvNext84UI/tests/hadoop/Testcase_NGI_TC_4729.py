...
Description: Create multiple raids, ideally spanning multiple disk sizes. See if ASM chooses all one size of disk, starting with lowest/largest disk.
'''
...
#         fileName = globalVars.jsonMap["bareMetalexsi"]
        fileName = "BAREMETAL_LINUX_4729.json"    
