...
Description: Install OS on the first VD, using Last/Rear, selecting Exactly # of disks required, with disks populated starting at Slot 1.
'''
...
#         fileName = globalVars.jsonMap["bareMetalexsi"]
        fileName = "BAREMETAL_LINUX_4727.json"    
