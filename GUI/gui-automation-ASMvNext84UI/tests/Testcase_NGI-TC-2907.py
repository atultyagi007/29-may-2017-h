...
Description: Baremetal Deployment with CentOS + Application + Server Scale-Up/Adding Validation
'''
...
class Testcase(Manager.Manager): 
    """
    Baremetal Deployment with CentOS & Application & Server Scale-Up
    """
    ...
    def preRunSetup(self):
        ...
        self.components["Scaleup"]["Server"]["Instances"] = 1
