'''
Author:raj.patel
Created Date: Oct 06, 2016
Description: End-to-end deployment with storage, vmware server, esxi cluster,  and Windows  VM with Applications.
'''
...
class Testcase(Manager.Manager): 
    """
    End-to-end deployment with storage, vmware server, esxi cluster,  and Windows  VM with Applications
    """
    ...
    def preRunSetup(self):
        ...
        fileName = "ESXI_EQL_Conv_4458.json"      
