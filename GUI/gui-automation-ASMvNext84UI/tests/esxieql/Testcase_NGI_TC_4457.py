...
Description: End-to-end deployment with storage, vmware server, esxi cluster,  and Redhat VMwith Applications
'''
...
class Testcase(Manager.Manager): 
    """
    End-to-end deployment with storage, vmware server, esxi cluster,  and Redhat VMwith Applications
    """
    ...
    def preRunSetup(self):
        ...
        fileName = "ESXI_EQL_Conv_4457.json"      
