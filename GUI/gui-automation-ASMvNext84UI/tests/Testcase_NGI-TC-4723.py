...
Description: ASM-6618/7001: Support to Set Multiple NTP Servers on OS - ESXI
...
class Testcase(Manager.Manager): 
    """
    ASM-6618/7001: Support to Set Multiple NTP Servers on OS - ESXI
    """
    ...
    def preRunSetup(self):
        ...
        fileName = globalVars.jsonMap["baremetalESXI"]        
        ...
        self.components["Template"]["Name"] = "Template_BAREMETAL_ESXI_MultipleNTP"
        
        #Change OS Image Value to ESXI Version
        self.components["Server"]["OSImage_Value"] = ["esxi-5.1"]
        #self.components["Server"]["OSImage_Value"] = ["esxi-5.5"]
        #self.components["Server"]["OSImage_Value"] = ["esxi-6.0"]
