...
Description: Perform firmware update after deployment completes
'''
...
class Testcase(Manager.Manager): 
    """
    Perform firmware update after deployment completes
"""
...
#         self.verifyResourceAvailability(self.components)
    ...
    def runTestCase(self):
        ...
        #update server firmware and verify
        self.updateServerFirmware()
