...
Description: Deploy now with firmware update option and verify the Deployment and Compliance state
'''
...
class Testcase(Manager.Manager): 
    """
    Deploy now with firmware update option and verify the Deployment and Compliance state
