...
Test-Case: NGI-TC-4463 ESXi with iSCSI equalLogic deployment with static networks for server and ASM selected IPs for VM
...
class Testcase(Manager.Manager): 
    """
    Description: ASM-4359: Specify Manual Static IPs for Networking during Deployment/NGI-TC-4463 ESXi with iSCSI equalLogic deployment with static networks for server and ASM selected IPs for VM
    """
    ...
    def preRunSetup(self):
        ...
        #Edit Template Name
        self.components["Template"]["Name"] = "Template_ESXI_EQL_StaticHost_ASMVM" 
