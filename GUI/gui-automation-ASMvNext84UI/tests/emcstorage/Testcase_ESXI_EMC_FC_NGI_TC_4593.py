'''
Author: raj.patel
Created Date: Aug 04, 2016
Description: EMC - End to end deployment with emc stoage, ESXi host, VMWare cluster, VMs and application.
Covered test cases are 4593,4594,4595,4596,4597,4598.
'''
