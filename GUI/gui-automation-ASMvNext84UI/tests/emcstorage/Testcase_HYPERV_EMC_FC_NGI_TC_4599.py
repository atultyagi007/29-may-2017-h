'''
Author: raj.patel
Created Date: Aug 01, 2016
Description: EMC - End to end deployment with EMC storage, HyperV host, Hyperv cluster, VMs and application.
Covered test cases are 4599,4600,4601,4602,4603,4604,4605,4606 .
'''
...
class Testcase(Manager.Manager): 
    """
    EMC - End to end deployment with EMC storage, HyperV host, Hyperv cluster, VMs and application
    """
...
#         fileName = globalVars.jsonMap["esxicplfc"]
        fileName="HYPERV_EMC.json"      
...
#         
#         self.scaleUpService('Service_Template_ESXI_EMC_FC_DIVERGED_2_PR', self.components)
#         
#         # Scale down service
#         
