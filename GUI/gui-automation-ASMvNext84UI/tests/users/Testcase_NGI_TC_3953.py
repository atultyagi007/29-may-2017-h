...
Description: AD User Change password should be disabled while editing a user.
Test Flow    : 1) Login as admin.
               2) Navigate to Users page.
               3) Create a new user.
               4) Edit newley created user.
...
class Testcase(Manager.Manager): 
    """
    AD User Change password should be disabled while editing a user.
    """
    ...
    def runTestCase(self):
        ...
        self.verifyeditADUserPasswordField(self.dirName)
