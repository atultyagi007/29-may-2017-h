...
Description: If a user is part of 2 group first group to import has that user
Test Flow    : 1) Login as admin.
               2) Navigate to Users page.
               3) Verify imported user.
...
class Testcase(Manager.Manager): 
    """
    If a user is part of 2 group first group to import has that user.
    """
