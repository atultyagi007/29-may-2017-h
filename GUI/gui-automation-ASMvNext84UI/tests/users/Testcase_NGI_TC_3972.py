...
Description: Try to login with AD imported user username and password application should through error.
...
class Testcase(Manager.Manager): 
    """
    Try to login with AD imported user username and password application should through error.
    """
