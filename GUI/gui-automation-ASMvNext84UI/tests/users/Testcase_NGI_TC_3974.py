...
Description: Type in first 3 letters on user group and filter it by all or user or group and it should return results accordingly
...
class Testcase(Manager.Manager): 
    """
   Type in first 3 letters on user group and filter it by all or user or group and it should return results accordingly
    """
