...
Description: Try to login with AD imported user username and password should  be able to login into application.
Test Flow    : 1) Login as admin.
               2) Navigate to Users page.
               3) Create a user.
               4) Try to login with AD imported user username and password.
...
class Testcase(Manager.Manager): 
    """
    Try to login with AD imported user username and password should  be able to login into application.
    """
    ...
    def runTestCase(self):
        ...
        self.logout()
        self.login(self.dirUname, self.dirPass, newInstance=True, negativeScenario=True)
