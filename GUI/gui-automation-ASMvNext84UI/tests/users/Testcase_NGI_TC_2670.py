...
Description: Verify that the Admin is able to disable specific Standard users, assigned to template/services.
'''
...
class Testcase(Manager.Manager): 
    """
    Admin is able to disable specific Standard users, assigned to template/services.
    """
