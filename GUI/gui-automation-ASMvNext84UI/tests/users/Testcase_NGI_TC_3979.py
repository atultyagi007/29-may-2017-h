...
Description: Verify all the users are imported into ASM with correct roles.
Test Flow    : 1) Login as admin.
               2) Navigate to Users page.
               3) Verify all the users are imported into ASM with correct roles.
...
class Testcase(Manager.Manager): 
    """
    Verify all the users are imported into ASM with correct roles.
    """
    ...
    def runTestCase(self):
        ...
        self.verifyADUserRole(self.dirName, "Read only")
