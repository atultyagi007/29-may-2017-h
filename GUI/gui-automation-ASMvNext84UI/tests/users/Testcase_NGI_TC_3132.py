...
Description: Verify Admin is able to edit Active Directory.
Test Flow    : 1) Login as admin.
               2) Navigate to Users page.
               3) create a new directory.
               4) Edit the Ad created in step 3.
...
class Testcase(Manager.Manager): 
    """
    Verify Admin is able to edit Active Directory.
    """
    ...
    def runTestCase(self):
        ...
        self.createActiveDirectory(self.dirType, self.dirName, self.dirUname, self.dirPass, self.host, self.port, self.protocol, self.baseDN, self.dirFilter, self.uNameAttr, self.fNameAttr, self.lNameAttr, self.emailAttr, self.dirSource, self.searchTerm, self.importRole, "pass")
        self.verifyEditActiveDirectory(self.dirName)
