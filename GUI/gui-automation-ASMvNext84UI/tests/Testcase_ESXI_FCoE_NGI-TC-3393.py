...
Description: FCoE - Cisco - Bro - End to end deployment with compellent stoage, ESXi host, VMWare cluster, VMs and application.
'''
...
class Testcase(Manager.Manager): 
    """
    FCoE - Cisco - Bro - End to end deployment with compellent stoage, ESXi host, VMWare cluster, VMs and application.
    """
    ...
    def preRunSetup(self):
        ...
        fileName = globalVars.jsonMap["esxifcoe"]        
