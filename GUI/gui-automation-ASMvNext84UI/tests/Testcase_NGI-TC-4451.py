...
Test-Case: NGI-TC-4451 HyperV with iSCSI EQL Diverged deployment with static networks for server
...
class Testcase(Manager.Manager): 
    """
    Description: ASM-4359: Specify Manual Static IPs for Networking during Deployment/NGI-TC-4451 HyperV with iSCSI EQL Diverged deployment with static networks for server
    """
    ...
    def preRunSetup(self):
        ...
        #Read JSON
        fileName = globalVars.jsonMap["hyperveqlstatic"]        
        ...
        #Edit Template Name
        self.components["Template"]["Name"] = "Template_HYPERV_EQL_Diverged_StaticIP" 
            
        #Change Network Type
        self.components["Server"]["Networks"] = "HYPERV_EQL_DIVERGED_2_REDUNDANCY"
