...
Description: Create a template for BFS and Deploy a server with Equalogic storage .
'''
...
class Testcase(Manager.Manager): 
    """
    Create a template for BFS and Deploy a server with Equalogic storage 
    """
    ...
    def preRunSetup(self):
        ...
        fileName = globalVars.jsonMap["bfsiscsi"]        
