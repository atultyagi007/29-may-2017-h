...
Description: Create template for BFS and deploy a server with Compellent storage.
'''
...
class Testcase(Manager.Manager): 
    """
    Create template for BFS and deploy a server with Compellent storage
    """
    ...
    def preRunSetup(self):
        ...
        fileName = globalVars.jsonMap["bfsfc"]        
