...
Description: Import AD users and assign Standard user role
Test Flow    : 1) Login as admin.
               2) Navigate to Users page and create a new directory.
               3) Import the user and assign Standard Role
...
class Testcase(Manager.Manager): 
    """
    Import AD users and assign Standard user role
    """
