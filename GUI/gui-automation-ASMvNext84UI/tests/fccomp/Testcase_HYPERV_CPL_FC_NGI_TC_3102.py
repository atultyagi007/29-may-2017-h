...
Description: FC - End to end deployment with compellent stoage, HyperV host, Hyperv cluster, VMs and application.
Covered test cases 3097,3102,3101,3100,3106,3105,3387,3889.
'''
...
class Testcase(Manager.Manager): 
    """
    FC - End to end deployment with compellent stoage, HyperV host, Hyperv cluster, VMs and application.
    """
    ...
    def preRunSetup(self):
        ...
        fileName = globalVars.jsonMap["hyperVcplfc"]        
