...
Description: Discover more resources, available resources should reflect the change
Test Flow    : 1) Log into the ASM UI and navigate to the Virtual Appliance Management page, 
              2)  Get available resources
              3) Discover more resources
              4) Validate available resources
              5) It also cover test case  NGI-TC-3062
'''
...
class Testcase(Manager.Manager): 
    ...
    def runTestCase(self):
        ...
        #Get details of Jobs    
        self.verifyResourcesInLicenseMgmt(resourceAction="discoverAction")
