...
Description: Enable DHCP setting and do a deployment.
Test Flow    : 1) Log into the ASM UI and navigate to the Virtual Appliance Management page, 
              2) Enable DHCP setting
              3) Do a Deployment
              4) It also cover test case  NGI-TC-2707, NGI-TC-2705 and NGI-TC-2708
'''
...
class Testcase(Manager.Manager): 
    ...
    def runTestCase(self):
        ...
        endIpAddress= globalVars.DHCP_EndingIpAddress 
