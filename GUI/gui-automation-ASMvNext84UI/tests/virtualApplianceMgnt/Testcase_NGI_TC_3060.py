...
class Testcase(Manager.Manager): 
    """
     Delete a resources, available resources should reflect the change
    ...
    def runTestCase(self):
        ...
        #Get details of Jobs    
        self.verifyResourcesInLicenseMgmt(resourceAction="deleteAction")
