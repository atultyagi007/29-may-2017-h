...
Description: Add 30 perputal on top of eval and it should replace eval
Test Flow    : 1) Log into the ASM UI and navigate to the Virtual Appliance Management page, 
              2) Add 30 perputal on top of eval
              3) It should replace License Type Evaluation to Standard
'''
...
class Testcase(Manager.Manager): 
    ...
    def preRunSetup(self):
        ...
        utility.execLog("Please run Testcase_NGI_TC_3058 before running this test case")       
    ...
    def runTestCase(self):
        ...
        #Get details of Jobs    
        self.addAndverifyLicenseType(evalLicensePath, licenseType = 'Standard')
