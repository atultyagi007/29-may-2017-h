...
Description: Enable DHCP setting  without  Gateway  and do a deployment.
Test Flow    : 1) Log into the ASM UI and navigate to the Virtual Appliance Management page, 
              2) Enable DHCP setting without  Gateway
              3) Do a Deployment
...
class Testcase(Manager.Manager): 
    """
     Enable DHCP setting without Gateway and do a deployment.
