...
Description: Add 30 perpetual license and  validate Expiry field
Test Flow    : 1) Log into the ASM UI and navigate to the Virtual Appliance Management page, 
              2) Add 30 perpetual license
              3) Expiry field should be either hidden or should have NA
              4) It also cover test case  NGI-TC-3068
'''
...
class Testcase(Manager.Manager): 
    """
     Add 30 perpetual license and validate Expiry field
