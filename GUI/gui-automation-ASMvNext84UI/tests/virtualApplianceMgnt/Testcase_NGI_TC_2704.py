...
class Testcase(Manager.Manager): 
    """
     Disable  DHCP setting and do a deployment.
    ...
    def runTestCase(self):
        ...
        self.enableDisableDHCPSettingMgr(resourceAction='Disable')
