...
Test-Case: NGI-TC-4462 Deploy from Storage to VM with Static Networks/ESXI+EQL
...
class Testcase(Manager.Manager): 
    """
    Description: ASM-4359: Specify Manual Static IPs for Networking during Deployment/NGI-TC-4462 Deploy from Storage to VM with Static Networks/ESXI+EQL
    """
    ...
    def preRunSetup(self):
        ...
        #Edit Template Name
        self.components["Template"]["Name"] = "Template_ESXI_EQL_Complete_StaticIP" 
