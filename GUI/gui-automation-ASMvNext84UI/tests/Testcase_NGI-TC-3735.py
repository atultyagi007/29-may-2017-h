...
Description: Baremetal Deployment with CentOS + Application + Post OS NIC Teaming (2-Port)/Adding Validation
'''
...
class Testcase(Manager.Manager): 
    ...
    def preRunSetup(self):
        ...
        #Change Network Type
        self.components["Server"]["Networks"] = "BAREMETAL_LINUX_2_TEAMING"
