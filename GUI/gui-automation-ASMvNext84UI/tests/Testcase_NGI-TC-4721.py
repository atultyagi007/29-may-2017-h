...
Description: ASM-6618/7001: Support to Set Multiple NTP Servers on OS - RHEL/CentOS
...
class Testcase(Manager.Manager): 
    """
    ASM-6618/7001: Support to Set Multiple NTP Servers on OS - RHEL/CentOS
    """
    ...
    def preRunSetup(self):
        ...
        self.components["Template"]["Name"] = "Template_BAREMETAL_LINUX_MultipleNTP"
        
        #Change OS Image Value to CentOS/RHEL 
        #self.components["Server"]["OSImage_Value"] = ["CentOS-6.7-x86_64_New"]
        #self.components["Server"]["OSImage_Value"] = ["CentOS-7"]
        self.components["Server"]["OSImage_Value"] = ["CentOS"]
        #self.components["Server"]["OSImage_Value"] = ["CentOS-7.2-x86_64"]
        #self.components["Server"]["OSImage_Value"] = ["RHEL-7.2-x86_64"]
        #self.components["Server"]["OSImage_Value"] = ["RHEL-server-6.7-x86_64"]
