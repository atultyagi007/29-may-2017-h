...
Description: Baremetal Deployment with CentOS + Application + Application Scale-Up/Adding Validation
'''
...
class Testcase(Manager.Manager): 
    """
    Baremetal Deployment with CentOS & Application & Application Scale-Up
    """
    ...
    def preRunSetup(self):
        ...
        self.components["Server"]["OSImage_Value"] = ["Centos7"]
        
        #Adding Application to Deployment
        self.components["Application"]["Instances"] = 1
        
        #Adding Scale-Up of Server
        self.components["Scaleup"]["Application"]["Instances"] = 1
