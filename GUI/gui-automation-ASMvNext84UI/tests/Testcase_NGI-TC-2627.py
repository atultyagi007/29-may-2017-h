...
Description: Verify that for each template shared by the Admin, the Standard user can View All settings 
            of the template in the Template detail page
'''
...
class Testcase(Manager.Manager): 
    """
    Standard user can View All settings of the template in the Template detail page
    """
