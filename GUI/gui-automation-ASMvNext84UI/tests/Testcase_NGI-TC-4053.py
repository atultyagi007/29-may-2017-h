...
Test Flow    : 1) Log into the ASM UI and navigate to the Ad-On Module page, 
              2) Add-On file with same application or component name is invalid.
              3)Prerequisite: Place the adam_linux_postinstall2.zip  file in docs folder of Project
'''
...
class Testcase(Manager.Manager): 
    """
     Add-On file with same application or component name is invalid
