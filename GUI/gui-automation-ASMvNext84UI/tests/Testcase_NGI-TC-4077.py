...
Test Flow    : 1) Log into the ASM UI and navigate to the Ad-On Module page, 
              2) Add-On modules check for puppet versions.
              3)Prerequisite: Place the adam_linux_postinstall1.zip  file in docs folder of Project
'''
...
class Testcase(Manager.Manager): 
    """
     Add-On modules check for puppet versions
