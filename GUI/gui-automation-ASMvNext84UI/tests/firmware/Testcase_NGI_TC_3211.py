...
class Testcase(Manager.Manager): 
    ...
    def runTestCase(self):
        ...
        #Add Repository
        self.addFirmwareRepository(option="networkPath",networkPath=globalVars.catlogRepository["nfsPathXml"],testConnection= False,waitAvailable= False)
        ...
        repoList = self.getFirmwareReposFromService("Test Template")
