...
Description :  Set a catalog in Template and deploy changing the catalog
...
class Testcase(Manager.Manager): 
    """
    Set a catalog in Template and deploy changing the catalog
    """
    ...
    def runTestCase(self):        
        ...
        if len(result) > 0:
            ...
            self.failure("Failed to Deploy Service '%s' in expected time"%self.serviceName)
