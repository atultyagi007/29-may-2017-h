...
Test Flow   :1)Login as a Admin user.  
             2)Verify IOA servers are discovered or not.
             3)Create user bundle for IOA switch.
             4)Compliance status of IOA server shall change form Non-compliant to Compliant on adding bundles
'''
...
class Testcase(Manager.Manager): 
    ...
    def runTestCase(self):        
        ...
        if nonCompliant:
            ...
            ComplianceStatus=self.getReourceModelComplainceStatus("Switches","I/O-Aggregator")
