...
Description : Create user bundle for S4810 Switch
Test Flow   :1)Login as a Admin user.  
             2)Verify S4810 servers are discovered or not.
             3)Create user bundle for S4810 switch.
             4)Compliance status of S4810 server shall change form Non-compliant to Compliant on adding bundles
'''
...
class Testcase(Manager.Manager): 
    """
    Create user bundle for switch S4810
    """
    ...
    def runTestCase(self):        
        ...
        self.verifyResourceModelAvailblity("Switches","S4810")
        ...
        self.addSwitch_CustomBundles(option="S4810", catalogName=repoName)
        nonCompliant=False
        ComplianceStatusPostBundleAdd=self.getReourceModelComplainceStatus("Switches","S4810")
        ...
        if nonCompliant:
            ...
            ComplianceStatus=self.getReourceModelComplainceStatus("Switches","S4810")
