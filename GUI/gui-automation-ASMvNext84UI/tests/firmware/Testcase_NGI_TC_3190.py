'''
Author: P.Suman
Created Date: Jan 1, 2016
Description: Enter valid path with invalid file name, should throw error
...
class Testcase(Manager.Manager): 
    """
    Enter valid path with invalid file name, should throw error
    """
    ...
    def runTestCase(self):
        ...
        if len(repositoryPath) > 0:
            repositoryPath = repositoryPath[:-1]            
        #Add Repository
