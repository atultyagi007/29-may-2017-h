...
Description:Validate Server- Template with 1 server with 1 2-port NIC and 1 FC NIC and RAID
'''
...
class Testcase(Manager.Manager): 
    """
    Validate Server- Template with 1 server with 1 2-port NIC and 1 FC NIC and RAID
    """
...
#         fileName = globalVars.jsonMap["bareMetalexsi"]
        fileName = "BAREMETAL_LINUX_3574.json"        
