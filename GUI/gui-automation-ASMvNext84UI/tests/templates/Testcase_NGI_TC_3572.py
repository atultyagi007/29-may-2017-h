...
Description:Validate Server- Template with 1 server with 1 4-port NIC and RAID
'''
...
class Testcase(Manager.Manager): 
    """
    Validate Server- Template with 1 server with 1 4-port NIC and RAID
    """
...
#         fileName = globalVars.jsonMap["bareMetalexsi"]
        fileName = "BAREMETAL_LINUX_3572.json"        
