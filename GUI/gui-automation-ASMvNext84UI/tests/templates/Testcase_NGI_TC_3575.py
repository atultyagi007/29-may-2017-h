...
Description:Validate Server- Template with 1 server with 1 NIC and NO RAID
'''
...
class Testcase(Manager.Manager): 
    """
    Validate Server- Template with 1 server with 1 NIC and NO RAID
    """
...
#         fileName = globalVars.jsonMap["bareMetalexsi"]
        fileName = "BAREMETAL_LINUX_3575.json"        
