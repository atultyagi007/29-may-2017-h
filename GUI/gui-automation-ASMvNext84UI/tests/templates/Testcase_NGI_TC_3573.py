...
Description:Validate Server- Template with 1 server with 2 NIC (2 port) and RAID
'''
...
class Testcase(Manager.Manager): 
    """
    Validate Server- Template with 1 server with 2 NIC (2 port) and RAID
    """
...
#         fileName = globalVars.jsonMap["bareMetalexsi"]
        fileName = "BAREMETAL_LINUX_3573.json"        
