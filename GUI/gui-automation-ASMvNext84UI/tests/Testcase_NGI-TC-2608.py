...
Description: Verify that on the Service detail page, the Standard user can Export to file and generate a 
            file containing information about the service.
"""
...
class Testcase(Manager.Manager): 
    """
    Standard user can Export to file and generate a file containing information about the service.
    """
    ...
    def runTestCase(self):
        ...
        self.getServiceOptions(actualOptions=["Export to File", "Delete", "Retry", "View All Settings", "Edit"], 
                    enableOptions=["Export to File"], serviceName=self.serviceName, serviceDetailOptions=True)
