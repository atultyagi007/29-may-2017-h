...
Description: Verify that if the Admin assigns all users while deploying without creating any user, there is no failure.
'''
...
class Testcase(Manager.Manager): 
    """
    Assign all users while deploying without creating any user.
    """
