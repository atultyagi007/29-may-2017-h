...
Description: Verify that the Admin can navigate to all pages without any errors 
            after disabling some/all Read-only users
'''
...
class Testcase(Manager.Manager): 
    """
    Admin can navigate to all pages without any errors after disabling Read-only users
    """
    ...
    def test_functionality(self):        
        ...
        self.disableLocalUser(globalVars.readOnlyUser, verifyUser=True)
        ...
        self.enableLocalUser(globalVars.readOnlyUser, verifyUser=True)