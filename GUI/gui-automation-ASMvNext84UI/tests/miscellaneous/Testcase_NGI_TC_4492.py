...
Description:   End-to-end deployment, scenario 4: 12g and 13g Racks; EQL + Hyper-V 
'''
...
class Testcase(Manager.Manager): 
    """
     End-to-end deployment, scenario 4: 12g and 13g Racks; EQL + Hyper-V 
    """
