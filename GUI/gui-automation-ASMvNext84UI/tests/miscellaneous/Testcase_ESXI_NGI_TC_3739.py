...
Description: Verify that correct type of server is selected for deployment.
'''
...
class Testcase(Manager.Manager): 
    """
    Verify that correct type of server is selected for deployment
    """
...
#         fileName = globalVars.jsonMap["bareMetalexsi"]
        fileName = "ESXI_CPL_ISCSI_Conv_3739.json"        
