...
Description: Run Inventory on EMC Storage device.
...
class Testcase(Manager.Manager): 
    """
    After the device is discovered run inventory on the EMC type storage.
    """
    ...
    def runTestCase(self):
        ...
        self.runInventory("Storage Center 25876")
