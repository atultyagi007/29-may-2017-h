...
Description: Deploy a template with cluster auto populated value with ,
            VM: Clone Hyper-V Virtual Machine & Cluster: Hyper-V cluster
'''
...
class Testcase(Manager.Manager): 
    """
    Deploy a template with cluster auto populated value with ,
            VM: Clone Hyper-V Virtual Machine & Cluster: Hyper-V cluster
    """
    ...
    def preRunSetup(self):
        ...
        fileName = globalVars.jsonMap["hypervclsutervm"]        
