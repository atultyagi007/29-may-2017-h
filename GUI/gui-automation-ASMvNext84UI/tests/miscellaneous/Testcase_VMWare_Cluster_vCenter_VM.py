...
Description: Deploy a template with cluster auto populated value with VM: VMWare & Cluster: vCenter
'''
...
class Testcase(Manager.Manager): 
    """
    Deploy a template with cluster auto populated value with VM: VMWare & Cluster: vCenter
    """
    ...
    def preRunSetup(self):
        ...
        fileName = globalVars.jsonMap["vmwareclustervcentervm"]        
