...
Description: Deploy Baremetal workflow with Addon module
'''
...
class Testcase(Manager.Manager): 
    """
     Deploy Baremetal workflow with Addon module
    """
    ...
    def runTestCase(self):
        ...
        #Verify application order And Deletion
        self.verifyApplicationOrder(self.components)   
