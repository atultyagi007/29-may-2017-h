...
Description:  End-to-end deployment, scenario 2: FX2 with 2210S + EQL + HyperV -P1.
'''
...
class Testcase(Manager.Manager): 
    """
     End-to-end deployment, scenario 2: FX2 with 2210S + EQL + HyperV -P1
    """
    ...
    def preRunSetup(self):
        ...
        chassisConfigFile= "chassisConfig_4490.json"
