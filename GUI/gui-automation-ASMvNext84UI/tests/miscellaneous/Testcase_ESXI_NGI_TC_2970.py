...
Description: All servers in the pool fail (server pool consists of same type of servers) - minimal server component.
'''
...
class Testcase(Manager.Manager): 
    """
    All servers in the pool fail (server pool consists of same type of servers) - minimal server component
    """
