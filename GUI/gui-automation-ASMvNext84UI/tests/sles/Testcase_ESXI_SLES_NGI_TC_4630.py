...
Description: Minimal server component deployment with SLES.
Covered test cases are 4630,4631,4632.
'''
...
class Testcase(Manager.Manager): 
    """
    Minimal server component deployment with SLES
    """
...
#         fileName = globalVars.jsonMap["esxicplfc"]
        fileName="ESXI_TC_4630_4632.json"      
