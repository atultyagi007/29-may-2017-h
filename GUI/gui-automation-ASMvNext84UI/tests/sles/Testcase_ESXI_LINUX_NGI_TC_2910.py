...
Description: Minimal server component deployment with LINUX.
Covered test cases are 2910,2911,2912.
'''
...
class Testcase(Manager.Manager): 
    """
    End to end deployment with emc stoage, ESXi host, VMWare cluster, VMs and application
    """
...
#         fileName = globalVars.jsonMap["esxicplfc"]
        fileName="ESXI_TC_2910_2912.json"      
...
# #         
        self.scaleUpService("Service_Testing_Template_ESXI_EMC_MinimalServer", self.components)
#         
#         # Scale down service
#         
