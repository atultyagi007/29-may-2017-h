...
Description: Netapp - End to end deployment with Netapp stoage, ESXi host, VMWare cluster, VMs and application.
Covered test cases 3120,3121,3117,3112,3113,3122,3124.
'''
...
class Testcase(Manager.Manager): 
    """
    Netapp - End to end deployment with Netapp stoage, ESXi host, VMWare cluster, VMs and application.
    """
    ...
    def preRunSetup(self):
        ...
        fileName = globalVars.jsonMap["esxinetapp"]        
