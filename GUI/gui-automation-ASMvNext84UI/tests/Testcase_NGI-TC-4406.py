...
Test-Case: NGI-TC-4406 ESXi with iSCSI Compellent deployment with static networks for server
...
class Testcase(Manager.Manager): 
    """
    Description: ASM-4359: Specify Manual Static IPs for Networking during Deployment/NGI-TC-4406 ESXi with iSCSI Compellent deployment with static networks for server
    """
    ...
    def preRunSetup(self):
        ...
        #Read JSON
        fileName = globalVars.jsonMap["esxicplstatic"]        
