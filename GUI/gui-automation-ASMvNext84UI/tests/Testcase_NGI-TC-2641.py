...
Description: Verify that for each template shared by the Admin, the Standard user can View detail of 
        each component in the Template detail page.
'''
...
class Testcase(Manager.Manager): 
    """
    Standard user can View detail of each component in the Template detail page.
    """
