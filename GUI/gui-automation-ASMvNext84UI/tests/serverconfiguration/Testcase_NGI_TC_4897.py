...
@author: raj.patel
Description:  Discover Rack Server, no configuration performed.
...
class Testcase(Manager.Manager): 
    """
     Discover Rack Server, no configuration performed
    """
...
#         self.deleteResource(self.resourceIP)
    ...
    def runTestCase(self):
        ...
        self.rackServerDiscovSchnario("Server", self.resourceIP ,self.resourceState,self.credentialName,self.userName,self.password,posSchanario=self.posSchanario,unCheck=self.unCheck)
