...
@author: raj.patel
Description:  Attempt to discover a C6220 II C series.
...
class Testcase(Manager.Manager): 
    """
     Attempt to discover a C6220 II C series
    """
...
#         self.deleteResource(self.resourceIP)
    ...
    def test_functionality(self):        
        ...
        self.resourceIP = "172.31.32.142"
#         172.31.60.136
        self.credentialName = "CSeries"+dateStr
