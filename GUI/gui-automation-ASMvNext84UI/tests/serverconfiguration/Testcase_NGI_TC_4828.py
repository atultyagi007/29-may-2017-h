...
@author: raj.patel
Description:  Discover a rack server, assign it a static IP when there are insufficient IP's.
...
class Testcase(Manager.Manager): 
    """
     Discover a rack server, assign it a static IP when there are insufficient IP's
    """
