...
@author: raj.patel
Description:  Discover a rack server and configure the server to use an invalid password (trailing space).
...
class Testcase(Manager.Manager): 
    """
     Discover a rack server and configure the server to use an invalid password (trailing space)
    """
