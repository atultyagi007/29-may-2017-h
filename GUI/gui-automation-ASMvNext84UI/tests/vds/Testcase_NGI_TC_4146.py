'''
Author: Atul.Kumar
Created Date: Sept 02, 2016
Description: Verify vSphere VDS Settings - 1 server, 2 port, 1 partition.
...
class Testcase(Manager.Manager): 
    """
       Verify vSphere VDS Settings - 1 server, 2 port, 1 partition.
    """
    ...
    def runTestCase(self):
        ...
        networkConfigDict={"vdsCount":1, "PXE Port Group":1, "Hypervisor Management Port Group":1,"autoHypervisorMigration Port Group":1,"Public LAN Port Group":1, "autoSANISCSI Port Group":2}
        #Create Template and Publish         
        self.buildTemplate(self.components, publishTemplate=True)
        # validate Cluter Component
