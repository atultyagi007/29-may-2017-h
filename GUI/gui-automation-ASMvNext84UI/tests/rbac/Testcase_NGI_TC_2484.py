...
Description: Verify that for each service on the Service detail page, the Read-only user 
            is not able to adjust any resources.
"""
...
class Testcase(Manager.Manager): 
    """
    Read-only unable to adjust any resources
    """
    ...
    def test_functionality(self):        
        ...
        self.getServiceOptions(actualOptions=["Export to File", "Delete", "Retry", "View All Settings", "Edit", "Add Resources"], 
                    disableOptions=["Add Resources"], serviceName=serviceName, serviceDetailOptions=True)
