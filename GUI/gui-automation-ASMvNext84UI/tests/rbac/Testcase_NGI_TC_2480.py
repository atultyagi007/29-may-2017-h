...
Description: Verify that on the Service detail page, the Read-only cannot edit a service.
"""
...
class Testcase(Manager.Manager): 
    """
    Read-only unable to edit a service.
    """
    ...
    def test_functionality(self):        
        ...
        self.getServiceOptions(actualOptions=["Export to File", "Delete", "Retry", "View All Settings", "Edit"], 
                    disableOptions=["Edit"], serviceName=serviceName, serviceDetailOptions=True)
