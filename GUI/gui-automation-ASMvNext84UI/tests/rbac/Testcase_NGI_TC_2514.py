...
Description: Verify that on the All Resources page, the Read-only user can filter the resources based on the Resource type.
'''
...
class Testcase(Manager.Manager): 
    """
    Read-only user can filter the resources based on the Resource type
    """
