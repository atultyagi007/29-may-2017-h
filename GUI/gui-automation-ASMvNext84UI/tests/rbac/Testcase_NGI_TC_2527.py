...
Description: Verify that for each service on the Services page, the Read-only user can View Details of the service.
"""
...
class Testcase(Manager.Manager): 
    """
    Read-only able to View Details of the service.
    """
