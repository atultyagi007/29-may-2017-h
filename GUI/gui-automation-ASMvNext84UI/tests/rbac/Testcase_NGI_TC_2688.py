...
Description: Verify that while deploying a service, the Admin can select specific Standard users to grant access to.
'''
...
class Testcase(Manager.Manager): 
    """
    While deploying a service, the Admin can select specific Standard users to grant access to.
    """
    ...
    def test_functionality(self):        
        ...
        self.deployService(templateName, serviceName, managePermissions=True, userList=[globalVars.standardUser])
