...
class Testcase(BaseClass.TestBase): 
    """
    Deploy a template ESXi with FCoE withBrocade Flow
    """
    ...
    def runTestCase(self):
        ...
        jsonPaylod = globalVars.Exsi_FCoE_With_BrocadeJsonPayload
    ...
    def test_functionality(self):
        """
        Deploy a template ESXi with FCoE NoBrocade Flow  
        """        
