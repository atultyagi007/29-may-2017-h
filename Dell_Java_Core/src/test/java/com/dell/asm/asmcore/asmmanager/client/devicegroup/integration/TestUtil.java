...
public class TestUtil {
    static final String JRAF_URL = "http://localhost:8080/JRAF";
    static final String ASMMANAGER_RA_URL = "http://localhost:8080/AsmManager";
    ...
    /* prettyPrintDevice: */
    /* ------------------------------------------------------------------------- */
    public static void prettyPrintDevice(DeviceGroup deviceGroup) {
        say("Properties for device: " + deviceGroup.getGroupName() + ":");
        say(Dump.toString(deviceGroup));
    }
